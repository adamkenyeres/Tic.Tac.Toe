...
/**
 * Pattern-specific match representation of the queries.TCNorthEast pattern,
 * to be used in conjunction with {@link TCNorthEastMatcher}.
 * 
...
public abstract class TCNorthEastMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCNorthEastMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return TCNorthEastMatch.parameterNames;
  }
  ...
  @Override
  public TCNorthEastMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCNorthEastMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCNorthEastMatch other = (TCNorthEastMatch) obj;
  ...
  @Override
  public TCNorthEastQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCNorthEastMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCNorthEastMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static TCNorthEastMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends TCNorthEastMatch {
  ...
  private static final class Immutable extends TCNorthEastMatch {
