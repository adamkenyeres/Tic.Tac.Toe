...
/**
 * Pattern-specific match representation of the queries.TCEast pattern,
 * to be used in conjunction with {@link TCEastMatcher}.
 * 
...
public abstract class TCEastMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCEastMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return TCEastMatch.parameterNames;
  }
  ...
  @Override
  public TCEastMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCEastMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCEastMatch other = (TCEastMatch) obj;
  ...
  @Override
  public TCEastQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCEastMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCEastMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static TCEastMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends TCEastMatch {
  ...
  private static final class Immutable extends TCEastMatch {
