...
/**
 * Pattern-specific match representation of the queries.OWinningVertical pattern,
 * to be used in conjunction with {@link OWinningVerticalMatcher}.
 * 
...
public abstract class OWinningVerticalMatch extends BasePatternMatch {
  ...
  private OWinningVerticalMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return OWinningVerticalMatch.parameterNames;
  }
  ...
  @Override
  public OWinningVerticalMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OWinningVerticalMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OWinningVerticalMatch other = (OWinningVerticalMatch) obj;
  ...
  @Override
  public OWinningVerticalQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OWinningVerticalMatch newEmptyMatch() {
   ...
   * 
   */
  public static OWinningVerticalMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static OWinningVerticalMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends OWinningVerticalMatch {
  ...
  private static final class Immutable extends OWinningVerticalMatch {
