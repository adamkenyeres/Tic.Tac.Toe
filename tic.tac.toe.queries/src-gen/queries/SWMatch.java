...
/**
 * Pattern-specific match representation of the queries.SW pattern,
 * to be used in conjunction with {@link SWMatcher}.
 * 
...
public abstract class SWMatch extends BasePatternMatch {
  ...
  private SWMatch(final Square pSource, final Square pTarget) {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SWMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
  ...
  @Override
  public SWQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SWMatch newEmptyMatch() {
   ...
   * 
   */
  public static SWMatch newMutableMatch(final Square pSource, final Square pTarget) {
   ...
   * 
   */
  public static SWMatch newMatch(final Square pSource, final Square pTarget) {
    return new Immutable(pSource, pTarget);
  }
  
  private static final class Mutable extends SWMatch {
  ...
  private static final class Immutable extends SWMatch {
