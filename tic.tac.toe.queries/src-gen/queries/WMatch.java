...
/**
 * Pattern-specific match representation of the queries.W pattern,
 * to be used in conjunction with {@link WMatcher}.
 * 
...
public abstract class WMatch extends BasePatternMatch {
  ...
  private WMatch(final Square pSource, final Square pTarget) {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof WMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
  ...
  @Override
  public WQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static WMatch newEmptyMatch() {
   ...
   * 
   */
  public static WMatch newMutableMatch(final Square pSource, final Square pTarget) {
   ...
   * 
   */
  public static WMatch newMatch(final Square pSource, final Square pTarget) {
    return new Immutable(pSource, pTarget);
  }
  
  private static final class Mutable extends WMatch {
  ...
  private static final class Immutable extends WMatch {
