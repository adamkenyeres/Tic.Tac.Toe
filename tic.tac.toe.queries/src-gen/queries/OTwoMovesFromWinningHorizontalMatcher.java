...
/**
 * Generated pattern matcher API of the queries.OTwoMovesFromWinningHorizontal pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link OTwoMovesFromWinningHorizontalMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * pattern
 ...
 * @see OTwoMovesFromWinningHorizontalProcessor
 * @see OTwoMovesFromWinningHorizontalQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class OTwoMovesFromWinningHorizontalMatcher extends BaseMatcher<OTwoMovesFromWinningHorizontalMatch> {
  /**
   ...
   * 
   */
  public static OTwoMovesFromWinningHorizontalMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    OTwoMovesFromWinningHorizontalMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (OTwoMovesFromWinningHorizontalMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static OTwoMovesFromWinningHorizontalMatcher create() throws ViatraQueryException {
    return new OTwoMovesFromWinningHorizontalMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OTwoMovesFromWinningHorizontalMatcher.class);
   ...
   * 
   */
  private OTwoMovesFromWinningHorizontalMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a OTwoMovesFromWinningHorizontalMatch object.
   * 
   */
  public Collection<OTwoMovesFromWinningHorizontalMatch> getAllMatches(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * @param pEngine the fixed value of pattern parameter engine, or null if not bound.
   * @param pColor the fixed value of pattern parameter color, or null if not bound.
   * @return a match represented as a OTwoMovesFromWinningHorizontalMatch object, or null if no match is found.
   * 
   */
  public OTwoMovesFromWinningHorizontalMatch getOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OTwoMovesFromWinningHorizontalMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OTwoMovesFromWinningHorizontalMatch> processor) {
   ...
   * 
   */
  public OTwoMovesFromWinningHorizontalMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return OTwoMovesFromWinningHorizontalMatch.newMatch(pSquare, pEngine, pColor);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final OTwoMovesFromWinningHorizontalMatch partialMatch) {
   ...
   * 
   */
  public Set<Engine> getAllValuesOfengine(final OTwoMovesFromWinningHorizontalMatch partialMatch) {
   ...
   * 
   */
  public Set<Color> getAllValuesOfcolor(final OTwoMovesFromWinningHorizontalMatch partialMatch) {
  ...
  @Override
  protected OTwoMovesFromWinningHorizontalMatch tupleToMatch(final Tuple t) {
    try {
    	return OTwoMovesFromWinningHorizontalMatch.newMatch((Square) t.get(POSITION_SQUARE), (Engine) t.get(POSITION_ENGINE), (Color) t.get(POSITION_COLOR));
  ...
  @Override
  protected OTwoMovesFromWinningHorizontalMatch arrayToMatch(final Object[] match) {
    try {
    	return OTwoMovesFromWinningHorizontalMatch.newMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected OTwoMovesFromWinningHorizontalMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return OTwoMovesFromWinningHorizontalMatch.newMutableMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<OTwoMovesFromWinningHorizontalMatcher> querySpecification() throws ViatraQueryException {
