...
/**
 * Generated pattern matcher API of the queries.TCEastWithEmptyMarks pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link TCEastWithEmptyMarksMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see TCEastWithEmptyMarksProcessor
 * @see TCEastWithEmptyMarksQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class TCEastWithEmptyMarksMatcher extends BaseMatcher<TCEastWithEmptyMarksMatch> {
  /**
   ...
   * 
   */
  public static TCEastWithEmptyMarksMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    TCEastWithEmptyMarksMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (TCEastWithEmptyMarksMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static TCEastWithEmptyMarksMatcher create() throws ViatraQueryException {
    return new TCEastWithEmptyMarksMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TCEastWithEmptyMarksMatcher.class);
   ...
   * 
   */
  private TCEastWithEmptyMarksMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a TCEastWithEmptyMarksMatch object.
   * 
   */
  public Collection<TCEastWithEmptyMarksMatch> getAllMatches(final Square pS1, final Square pS2, final Engine pEngine) {
   ...
   * @param pS2 the fixed value of pattern parameter s2, or null if not bound.
   * @param pEngine the fixed value of pattern parameter engine, or null if not bound.
   * @return a match represented as a TCEastWithEmptyMarksMatch object, or null if no match is found.
   * 
   */
  public TCEastWithEmptyMarksMatch getOneArbitraryMatch(final Square pS1, final Square pS2, final Engine pEngine) {
   ...
   * 
   */
  public void forEachMatch(final Square pS1, final Square pS2, final Engine pEngine, final IMatchProcessor<? super TCEastWithEmptyMarksMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pS1, final Square pS2, final Engine pEngine, final IMatchProcessor<? super TCEastWithEmptyMarksMatch> processor) {
   ...
   * 
   */
  public TCEastWithEmptyMarksMatch newMatch(final Square pS1, final Square pS2, final Engine pEngine) {
    return TCEastWithEmptyMarksMatch.newMatch(pS1, pS2, pEngine);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfs1(final TCEastWithEmptyMarksMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfs2(final TCEastWithEmptyMarksMatch partialMatch) {
   ...
   * 
   */
  public Set<Engine> getAllValuesOfengine(final TCEastWithEmptyMarksMatch partialMatch) {
  ...
  @Override
  protected TCEastWithEmptyMarksMatch tupleToMatch(final Tuple t) {
    try {
    	return TCEastWithEmptyMarksMatch.newMatch((Square) t.get(POSITION_S1), (Square) t.get(POSITION_S2), (Engine) t.get(POSITION_ENGINE));
  ...
  @Override
  protected TCEastWithEmptyMarksMatch arrayToMatch(final Object[] match) {
    try {
    	return TCEastWithEmptyMarksMatch.newMatch((Square) match[POSITION_S1], (Square) match[POSITION_S2], (Engine) match[POSITION_ENGINE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected TCEastWithEmptyMarksMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return TCEastWithEmptyMarksMatch.newMutableMatch((Square) match[POSITION_S1], (Square) match[POSITION_S2], (Engine) match[POSITION_ENGINE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<TCEastWithEmptyMarksMatcher> querySpecification() throws ViatraQueryException {
