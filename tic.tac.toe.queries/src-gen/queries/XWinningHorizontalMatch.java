...
/**
 * Pattern-specific match representation of the queries.XWinningHorizontal pattern,
 * to be used in conjunction with {@link XWinningHorizontalMatcher}.
 * 
...
public abstract class XWinningHorizontalMatch extends BasePatternMatch {
  ...
  private XWinningHorizontalMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return XWinningHorizontalMatch.parameterNames;
  }
  ...
  @Override
  public XWinningHorizontalMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof XWinningHorizontalMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    XWinningHorizontalMatch other = (XWinningHorizontalMatch) obj;
  ...
  @Override
  public XWinningHorizontalQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static XWinningHorizontalMatch newEmptyMatch() {
   ...
   * 
   */
  public static XWinningHorizontalMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static XWinningHorizontalMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends XWinningHorizontalMatch {
  ...
  private static final class Immutable extends XWinningHorizontalMatch {
