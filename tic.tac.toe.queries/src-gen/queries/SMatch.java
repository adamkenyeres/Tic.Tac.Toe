...
/**
 * Pattern-specific match representation of the queries.S pattern,
 * to be used in conjunction with {@link SMatcher}.
 * 
...
public abstract class SMatch extends BasePatternMatch {
  ...
  private SMatch(final Square pSource, final Square pTarget) {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
  ...
  @Override
  public SQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SMatch newEmptyMatch() {
   ...
   * 
   */
  public static SMatch newMutableMatch(final Square pSource, final Square pTarget) {
   ...
   * 
   */
  public static SMatch newMatch(final Square pSource, final Square pTarget) {
    return new Immutable(pSource, pTarget);
  }
  
  private static final class Mutable extends SMatch {
  ...
  private static final class Immutable extends SMatch {
