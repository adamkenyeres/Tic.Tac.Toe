...
/**
 * Pattern-specific match representation of the queries.TCNorthWithSameMarks pattern,
 * to be used in conjunction with {@link TCNorthWithSameMarksMatcher}.
 * 
...
public abstract class TCNorthWithSameMarksMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCNorthWithSameMarksMatch(final Square pS1, final Square pS2, final Color pColor) {
    this.fS1 = pS1;
    this.fS2 = pS2;
    this.fColor = pColor;
  }
  ...
  public List<String> parameterNames() {
    return TCNorthWithSameMarksMatch.parameterNames;
  }
  ...
  @Override
  public TCNorthWithSameMarksMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCNorthWithSameMarksMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCNorthWithSameMarksMatch other = (TCNorthWithSameMarksMatch) obj;
  ...
  @Override
  public TCNorthWithSameMarksQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCNorthWithSameMarksMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCNorthWithSameMarksMatch newMutableMatch(final Square pS1, final Square pS2, final Color pColor) {
   ...
   * 
   */
  public static TCNorthWithSameMarksMatch newMatch(final Square pS1, final Square pS2, final Color pColor) {
    return new Immutable(pS1, pS2, pColor);
  }
  
  private static final class Mutable extends TCNorthWithSameMarksMatch {
  ...
  private static final class Immutable extends TCNorthWithSameMarksMatch {
