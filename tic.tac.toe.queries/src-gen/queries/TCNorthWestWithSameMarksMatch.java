...
/**
 * Pattern-specific match representation of the queries.TCNorthWestWithSameMarks pattern,
 * to be used in conjunction with {@link TCNorthWestWithSameMarksMatcher}.
 * 
...
public abstract class TCNorthWestWithSameMarksMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCNorthWestWithSameMarksMatch(final Square pS1, final Square pS2, final Color pColor) {
    this.fS1 = pS1;
    this.fS2 = pS2;
    this.fColor = pColor;
  }
  ...
  public List<String> parameterNames() {
    return TCNorthWestWithSameMarksMatch.parameterNames;
  }
  ...
  @Override
  public TCNorthWestWithSameMarksMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCNorthWestWithSameMarksMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCNorthWestWithSameMarksMatch other = (TCNorthWestWithSameMarksMatch) obj;
  ...
  @Override
  public TCNorthWestWithSameMarksQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCNorthWestWithSameMarksMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCNorthWestWithSameMarksMatch newMutableMatch(final Square pS1, final Square pS2, final Color pColor) {
   ...
   * 
   */
  public static TCNorthWestWithSameMarksMatch newMatch(final Square pS1, final Square pS2, final Color pColor) {
    return new Immutable(pS1, pS2, pColor);
  }
  
  private static final class Mutable extends TCNorthWestWithSameMarksMatch {
  ...
  private static final class Immutable extends TCNorthWestWithSameMarksMatch {
