...
/**
 * Pattern-specific match representation of the queries.OTwoMovesFromWinningDiagonalLeft pattern,
 * to be used in conjunction with {@link OTwoMovesFromWinningDiagonalLeftMatcher}.
 * 
...
public abstract class OTwoMovesFromWinningDiagonalLeftMatch extends BasePatternMatch {
  ...
  private OTwoMovesFromWinningDiagonalLeftMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return OTwoMovesFromWinningDiagonalLeftMatch.parameterNames;
  }
  ...
  @Override
  public OTwoMovesFromWinningDiagonalLeftMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OTwoMovesFromWinningDiagonalLeftMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OTwoMovesFromWinningDiagonalLeftMatch other = (OTwoMovesFromWinningDiagonalLeftMatch) obj;
  ...
  @Override
  public OTwoMovesFromWinningDiagonalLeftQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OTwoMovesFromWinningDiagonalLeftMatch newEmptyMatch() {
   ...
   * 
   */
  public static OTwoMovesFromWinningDiagonalLeftMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static OTwoMovesFromWinningDiagonalLeftMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends OTwoMovesFromWinningDiagonalLeftMatch {
  ...
  private static final class Immutable extends OTwoMovesFromWinningDiagonalLeftMatch {
