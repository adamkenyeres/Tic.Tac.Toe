...
/**
 * Pattern-specific match representation of the queries.TCSouthWest pattern,
 * to be used in conjunction with {@link TCSouthWestMatcher}.
 * 
...
public abstract class TCSouthWestMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCSouthWestMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return TCSouthWestMatch.parameterNames;
  }
  ...
  @Override
  public TCSouthWestMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCSouthWestMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCSouthWestMatch other = (TCSouthWestMatch) obj;
  ...
  @Override
  public TCSouthWestQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCSouthWestMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCSouthWestMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static TCSouthWestMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends TCSouthWestMatch {
  ...
  private static final class Immutable extends TCSouthWestMatch {
