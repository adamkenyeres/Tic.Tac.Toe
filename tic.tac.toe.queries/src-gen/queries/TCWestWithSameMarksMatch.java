...
/**
 * Pattern-specific match representation of the queries.TCWestWithSameMarks pattern,
 * to be used in conjunction with {@link TCWestWithSameMarksMatcher}.
 * 
...
public abstract class TCWestWithSameMarksMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCWestWithSameMarksMatch(final Square pS1, final Square pS2, final Color pColor) {
    this.fS1 = pS1;
    this.fS2 = pS2;
    this.fColor = pColor;
  }
  ...
  public List<String> parameterNames() {
    return TCWestWithSameMarksMatch.parameterNames;
  }
  ...
  @Override
  public TCWestWithSameMarksMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCWestWithSameMarksMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCWestWithSameMarksMatch other = (TCWestWithSameMarksMatch) obj;
  ...
  @Override
  public TCWestWithSameMarksQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCWestWithSameMarksMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCWestWithSameMarksMatch newMutableMatch(final Square pS1, final Square pS2, final Color pColor) {
   ...
   * 
   */
  public static TCWestWithSameMarksMatch newMatch(final Square pS1, final Square pS2, final Color pColor) {
    return new Immutable(pS1, pS2, pColor);
  }
  
  private static final class Mutable extends TCWestWithSameMarksMatch {
  ...
  private static final class Immutable extends TCWestWithSameMarksMatch {
