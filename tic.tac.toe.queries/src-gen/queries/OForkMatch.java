...
/**
 * Pattern-specific match representation of the queries.OFork pattern,
 * to be used in conjunction with {@link OForkMatcher}.
 * 
...
public abstract class OForkMatch extends BasePatternMatch {
  ...
  private OForkMatch(final Square pSquare, final Engine pEngine) {
  ...
  public List<String> parameterNames() {
    return OForkMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OForkMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OForkMatch other = (OForkMatch) obj;
  ...
  @Override
  public OForkQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OForkMatch newEmptyMatch() {
   ...
   * 
   */
  public static OForkMatch newMutableMatch(final Square pSquare, final Engine pEngine) {
   ...
   * 
   */
  public static OForkMatch newMatch(final Square pSquare, final Engine pEngine) {
    return new Immutable(pSquare, pEngine);
  }
  
  private static final class Mutable extends OForkMatch {
  ...
  private static final class Immutable extends OForkMatch {
