...
/**
 * Pattern-specific match representation of the queries.XMoves pattern,
 * to be used in conjunction with {@link XMovesMatcher}.
 * 
...
public abstract class XMovesMatch extends BasePatternMatch {
  ...
  private XMovesMatch(final Square pSquare, final Engine pEngine) {
  ...
  public List<String> parameterNames() {
    return XMovesMatch.parameterNames;
  }
  ...
  @Override
  public XMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof XMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    XMovesMatch other = (XMovesMatch) obj;
  ...
  @Override
  public XMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static XMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static XMovesMatch newMutableMatch(final Square pSquare, final Engine pEngine) {
   ...
   * 
   */
  public static XMovesMatch newMatch(final Square pSquare, final Engine pEngine) {
    return new Immutable(pSquare, pEngine);
  }
  
  private static final class Mutable extends XMovesMatch {
  ...
  private static final class Immutable extends XMovesMatch {
