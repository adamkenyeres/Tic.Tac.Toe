...
/**
 * Pattern-specific match representation of the queries.TCNorth pattern,
 * to be used in conjunction with {@link TCNorthMatcher}.
 * 
...
public abstract class TCNorthMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCNorthMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return TCNorthMatch.parameterNames;
  }
  ...
  @Override
  public TCNorthMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCNorthMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCNorthMatch other = (TCNorthMatch) obj;
  ...
  @Override
  public TCNorthQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCNorthMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCNorthMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static TCNorthMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends TCNorthMatch {
  ...
  private static final class Immutable extends TCNorthMatch {
