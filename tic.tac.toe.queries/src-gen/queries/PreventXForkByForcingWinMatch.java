...
/**
 * Pattern-specific match representation of the queries.preventXForkByForcingWin pattern,
 * to be used in conjunction with {@link PreventXForkByForcingWinMatcher}.
 * 
...
public abstract class PreventXForkByForcingWinMatch extends BasePatternMatch {
  ...
  private PreventXForkByForcingWinMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return PreventXForkByForcingWinMatch.parameterNames;
  }
  ...
  @Override
  public PreventXForkByForcingWinMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof PreventXForkByForcingWinMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    PreventXForkByForcingWinMatch other = (PreventXForkByForcingWinMatch) obj;
  ...
  @Override
  public PreventXForkByForcingWinQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static PreventXForkByForcingWinMatch newEmptyMatch() {
   ...
   * 
   */
  public static PreventXForkByForcingWinMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static PreventXForkByForcingWinMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends PreventXForkByForcingWinMatch {
  ...
  private static final class Immutable extends PreventXForkByForcingWinMatch {
