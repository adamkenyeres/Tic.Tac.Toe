...
/**
 * Generated pattern matcher API of the queries.XWinningDiagonalRight pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link XWinningDiagonalRightMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see XWinningDiagonalRightQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class XWinningDiagonalRightMatcher extends BaseMatcher<XWinningDiagonalRightMatch> {
  /**
   ...
   * 
   */
  public static XWinningDiagonalRightMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    XWinningDiagonalRightMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (XWinningDiagonalRightMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static XWinningDiagonalRightMatcher create() throws ViatraQueryException {
    return new XWinningDiagonalRightMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(XWinningDiagonalRightMatcher.class);
   ...
   * 
   */
  private XWinningDiagonalRightMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a XWinningDiagonalRightMatch object.
   * 
   */
  public Collection<XWinningDiagonalRightMatch> getAllMatches(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * @param pEngine the fixed value of pattern parameter engine, or null if not bound.
   * @param pColor the fixed value of pattern parameter color, or null if not bound.
   * @return a match represented as a XWinningDiagonalRightMatch object, or null if no match is found.
   * 
   */
  public XWinningDiagonalRightMatch getOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super XWinningDiagonalRightMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super XWinningDiagonalRightMatch> processor) {
   ...
   * 
   */
  public XWinningDiagonalRightMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return XWinningDiagonalRightMatch.newMatch(pSquare, pEngine, pColor);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final XWinningDiagonalRightMatch partialMatch) {
   ...
   * 
   */
  public Set<Engine> getAllValuesOfengine(final XWinningDiagonalRightMatch partialMatch) {
   ...
   * 
   */
  public Set<Color> getAllValuesOfcolor(final XWinningDiagonalRightMatch partialMatch) {
  ...
  @Override
  protected XWinningDiagonalRightMatch tupleToMatch(final Tuple t) {
    try {
    	return XWinningDiagonalRightMatch.newMatch((Square) t.get(POSITION_SQUARE), (Engine) t.get(POSITION_ENGINE), (Color) t.get(POSITION_COLOR));
  ...
  @Override
  protected XWinningDiagonalRightMatch arrayToMatch(final Object[] match) {
    try {
    	return XWinningDiagonalRightMatch.newMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected XWinningDiagonalRightMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return XWinningDiagonalRightMatch.newMutableMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<XWinningDiagonalRightMatcher> querySpecification() throws ViatraQueryException {
