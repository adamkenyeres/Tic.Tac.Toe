...
import queries.OWinningDiagonalLeftMatch;
...
/**
 * Generated pattern matcher API of the queries.OWinningDiagonalLeft pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link OWinningDiagonalLeftMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see OWinningDiagonalLeftMatch
 * @see OWinningDiagonalLeftProcessor
 * @see OWinningDiagonalLeftQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class OWinningDiagonalLeftMatcher extends BaseMatcher<OWinningDiagonalLeftMatch> {
  /**
   ...
   * 
   */
  public static OWinningDiagonalLeftMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    OWinningDiagonalLeftMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (OWinningDiagonalLeftMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static OWinningDiagonalLeftMatcher create() throws ViatraQueryException {
    return new OWinningDiagonalLeftMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OWinningDiagonalLeftMatcher.class);
   ...
   * 
   */
  private OWinningDiagonalLeftMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a OWinningDiagonalLeftMatch object.
   * 
   */
  public Collection<OWinningDiagonalLeftMatch> getAllMatches(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * @param pEngine the fixed value of pattern parameter engine, or null if not bound.
   * @param pColor the fixed value of pattern parameter color, or null if not bound.
   * @return a match represented as a OWinningDiagonalLeftMatch object, or null if no match is found.
   * 
   */
  public OWinningDiagonalLeftMatch getOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OWinningDiagonalLeftMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OWinningDiagonalLeftMatch> processor) {
   ...
   * 
   */
  public OWinningDiagonalLeftMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return OWinningDiagonalLeftMatch.newMatch(pSquare, pEngine, pColor);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final OWinningDiagonalLeftMatch partialMatch) {
   ...
   * 
   */
  public Set<Engine> getAllValuesOfengine(final OWinningDiagonalLeftMatch partialMatch) {
   ...
   * 
   */
  public Set<Color> getAllValuesOfcolor(final OWinningDiagonalLeftMatch partialMatch) {
  ...
  @Override
  protected OWinningDiagonalLeftMatch tupleToMatch(final Tuple t) {
    try {
    	return OWinningDiagonalLeftMatch.newMatch((Square) t.get(POSITION_SQUARE), (Engine) t.get(POSITION_ENGINE), (Color) t.get(POSITION_COLOR));
  ...
  @Override
  protected OWinningDiagonalLeftMatch arrayToMatch(final Object[] match) {
    try {
    	return OWinningDiagonalLeftMatch.newMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected OWinningDiagonalLeftMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return OWinningDiagonalLeftMatch.newMutableMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<OWinningDiagonalLeftMatcher> querySpecification() throws ViatraQueryException {
