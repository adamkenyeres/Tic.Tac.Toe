...
/**
 * Pattern-specific match representation of the queries.TCSouthWithSameMarks pattern,
 * to be used in conjunction with {@link TCSouthWithSameMarksMatcher}.
 * 
...
public abstract class TCSouthWithSameMarksMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCSouthWithSameMarksMatch(final Square pS1, final Square pS2, final Color pColor) {
    this.fS1 = pS1;
    this.fS2 = pS2;
    this.fColor = pColor;
  }
  ...
  public List<String> parameterNames() {
    return TCSouthWithSameMarksMatch.parameterNames;
  }
  ...
  @Override
  public TCSouthWithSameMarksMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCSouthWithSameMarksMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCSouthWithSameMarksMatch other = (TCSouthWithSameMarksMatch) obj;
  ...
  @Override
  public TCSouthWithSameMarksQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCSouthWithSameMarksMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCSouthWithSameMarksMatch newMutableMatch(final Square pS1, final Square pS2, final Color pColor) {
   ...
   * 
   */
  public static TCSouthWithSameMarksMatch newMatch(final Square pS1, final Square pS2, final Color pColor) {
    return new Immutable(pS1, pS2, pColor);
  }
  
  private static final class Mutable extends TCSouthWithSameMarksMatch {
  ...
  private static final class Immutable extends TCSouthWithSameMarksMatch {
