...
/**
 * Pattern-specific match representation of the queries.TCSouthWithEmptyMarks pattern,
 * to be used in conjunction with {@link TCSouthWithEmptyMarksMatcher}.
 * 
...
public abstract class TCSouthWithEmptyMarksMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCSouthWithEmptyMarksMatch(final Square pS1, final Square pS2, final Engine pEngine) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  ...
  public List<String> parameterNames() {
    return TCSouthWithEmptyMarksMatch.parameterNames;
  }
  ...
  @Override
  public TCSouthWithEmptyMarksMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCSouthWithEmptyMarksMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCSouthWithEmptyMarksMatch other = (TCSouthWithEmptyMarksMatch) obj;
  ...
  @Override
  public TCSouthWithEmptyMarksQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCSouthWithEmptyMarksMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCSouthWithEmptyMarksMatch newMutableMatch(final Square pS1, final Square pS2, final Engine pEngine) {
   ...
   * 
   */
  public static TCSouthWithEmptyMarksMatch newMatch(final Square pS1, final Square pS2, final Engine pEngine) {
    return new Immutable(pS1, pS2, pEngine);
  }
  
  private static final class Mutable extends TCSouthWithEmptyMarksMatch {
  ...
  private static final class Immutable extends TCSouthWithEmptyMarksMatch {
