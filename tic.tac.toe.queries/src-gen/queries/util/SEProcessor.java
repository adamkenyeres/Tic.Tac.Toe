...
/**
 * A match processor tailored for the queries.SE pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class SEProcessor implements IMatchProcessor<SEMatch> {
  /**
  ...
  @Override
  public void process(final SEMatch match) {
