...
/**
 * A pattern-specific query specification that can instantiate TCSouthWestWithSameMarksMatcher in a type-safe way.
 * 
 * @see TCSouthWestWithSameMarksMatcher
 * @see TCSouthWestWithSameMarksMatch
 * 
 */
@SuppressWarnings("all")
public final class TCSouthWestWithSameMarksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCSouthWestWithSameMarksMatcher> {
  private TCSouthWestWithSameMarksQuerySpecification() {
   ...
   * 
   */
  public static TCSouthWestWithSameMarksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCSouthWestWithSameMarksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCSouthWestWithSameMarksMatcher.on(engine);
  }
  
  @Override
  public TCSouthWestWithSameMarksMatcher instantiate() throws ViatraQueryException {
    return TCSouthWestWithSameMarksMatcher.create();
  }
  
  @Override
  public TCSouthWestWithSameMarksMatch newEmptyMatch() {
    return TCSouthWestWithSameMarksMatch.newEmptyMatch();
  }
  
  @Override
  public TCSouthWestWithSameMarksMatch newMatch(final Object... parameters) {
    return TCSouthWestWithSameMarksMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCSouthWestWithSameMarksQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCSouthWestWithSameMarksQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCSouthWestWithSameMarksQuerySpecification INSTANCE = new TCSouthWestWithSameMarksQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCSouthWestWithSameMarksQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.TCSouthWestWithSameMarks";
    }
