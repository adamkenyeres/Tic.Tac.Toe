...
/**
 * A pattern-specific query specification that can instantiate OWinningDiagonalLeftMatcher in a type-safe way.
 * 
 * @see OWinningDiagonalLeftMatcher
 * @see OWinningDiagonalLeftMatch
 * 
 */
@SuppressWarnings("all")
public final class OWinningDiagonalLeftQuerySpecification extends BaseGeneratedEMFQuerySpecification<OWinningDiagonalLeftMatcher> {
  private OWinningDiagonalLeftQuerySpecification() {
   ...
   * 
   */
  public static OWinningDiagonalLeftQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected OWinningDiagonalLeftMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return OWinningDiagonalLeftMatcher.on(engine);
  }
  
  @Override
  public OWinningDiagonalLeftMatcher instantiate() throws ViatraQueryException {
    return OWinningDiagonalLeftMatcher.create();
  }
  
  @Override
  public OWinningDiagonalLeftMatch newEmptyMatch() {
    return OWinningDiagonalLeftMatch.newEmptyMatch();
  }
  
  @Override
  public OWinningDiagonalLeftMatch newMatch(final Object... parameters) {
    return OWinningDiagonalLeftMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OWinningDiagonalLeftQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link OWinningDiagonalLeftQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static OWinningDiagonalLeftQuerySpecification INSTANCE = new OWinningDiagonalLeftQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static OWinningDiagonalLeftQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.OWinningDiagonalLeft";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public String getShortDescription() {
      		        return "Expression evaluation from pattern OWinningDiagonalLeft";
      		    }
