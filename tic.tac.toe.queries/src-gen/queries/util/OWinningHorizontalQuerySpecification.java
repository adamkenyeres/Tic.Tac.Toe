...
/**
 * A pattern-specific query specification that can instantiate OWinningHorizontalMatcher in a type-safe way.
 * 
 * @see OWinningHorizontalMatcher
 * @see OWinningHorizontalMatch
 * 
 */
@SuppressWarnings("all")
public final class OWinningHorizontalQuerySpecification extends BaseGeneratedEMFQuerySpecification<OWinningHorizontalMatcher> {
  private OWinningHorizontalQuerySpecification() {
   ...
   * 
   */
  public static OWinningHorizontalQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected OWinningHorizontalMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return OWinningHorizontalMatcher.on(engine);
  }
  
  @Override
  public OWinningHorizontalMatcher instantiate() throws ViatraQueryException {
    return OWinningHorizontalMatcher.create();
  }
  
  @Override
  public OWinningHorizontalMatch newEmptyMatch() {
    return OWinningHorizontalMatch.newEmptyMatch();
  }
  
  @Override
  public OWinningHorizontalMatch newMatch(final Object... parameters) {
    return OWinningHorizontalMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OWinningHorizontalQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link OWinningHorizontalQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static OWinningHorizontalQuerySpecification INSTANCE = new OWinningHorizontalQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static OWinningHorizontalQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.OWinningHorizontal";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public String getShortDescription() {
      		        return "Expression evaluation from pattern OWinningHorizontal";
      		    }
