...
/**
 * A match processor tailored for the queries.TCSouthWithEmptyMarks pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCSouthWithEmptyMarksProcessor implements IMatchProcessor<TCSouthWithEmptyMarksMatch> {
  /**
  ...
  @Override
  public void process(final TCSouthWithEmptyMarksMatch match) {
