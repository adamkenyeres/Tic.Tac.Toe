...
/**
 * A match processor tailored for the queries.XMoves pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class XMovesProcessor implements IMatchProcessor<XMovesMatch> {
  /**
  ...
  @Override
  public void process(final XMovesMatch match) {
