...
/**
 * A pattern-specific query specification that can instantiate TCEastWithSameMarksMatcher in a type-safe way.
 * 
 * @see TCEastWithSameMarksMatcher
 * @see TCEastWithSameMarksMatch
 * 
 */
@SuppressWarnings("all")
public final class TCEastWithSameMarksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCEastWithSameMarksMatcher> {
  private TCEastWithSameMarksQuerySpecification() {
   ...
   * 
   */
  public static TCEastWithSameMarksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCEastWithSameMarksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCEastWithSameMarksMatcher.on(engine);
  }
  
  @Override
  public TCEastWithSameMarksMatcher instantiate() throws ViatraQueryException {
    return TCEastWithSameMarksMatcher.create();
  }
  
  @Override
  public TCEastWithSameMarksMatch newEmptyMatch() {
    return TCEastWithSameMarksMatch.newEmptyMatch();
  }
  
  @Override
  public TCEastWithSameMarksMatch newMatch(final Object... parameters) {
    return TCEastWithSameMarksMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCEastWithSameMarksQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCEastWithSameMarksQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCEastWithSameMarksQuerySpecification INSTANCE = new TCEastWithSameMarksQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCEastWithSameMarksQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.TCEastWithSameMarks";
    }
