...
/**
 * A match processor tailored for the queries.TCSouth pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCSouthProcessor implements IMatchProcessor<TCSouthMatch> {
  /**
  ...
  @Override
  public void process(final TCSouthMatch match) {
