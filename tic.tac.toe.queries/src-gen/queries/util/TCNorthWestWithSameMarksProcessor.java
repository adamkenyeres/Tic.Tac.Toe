...
/**
 * A match processor tailored for the queries.TCNorthWestWithSameMarks pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCNorthWestWithSameMarksProcessor implements IMatchProcessor<TCNorthWestWithSameMarksMatch> {
  /**
  ...
  @Override
  public void process(final TCNorthWestWithSameMarksMatch match) {
