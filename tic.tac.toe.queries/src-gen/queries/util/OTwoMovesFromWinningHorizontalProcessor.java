...
/**
 * A match processor tailored for the queries.OTwoMovesFromWinningHorizontal pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class OTwoMovesFromWinningHorizontalProcessor implements IMatchProcessor<OTwoMovesFromWinningHorizontalMatch> {
  /**
  ...
  @Override
  public void process(final OTwoMovesFromWinningHorizontalMatch match) {
