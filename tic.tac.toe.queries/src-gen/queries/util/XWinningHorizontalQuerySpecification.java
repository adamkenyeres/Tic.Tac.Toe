...
/**
 * A pattern-specific query specification that can instantiate XWinningHorizontalMatcher in a type-safe way.
 * 
 * @see XWinningHorizontalMatcher
 * @see XWinningHorizontalMatch
 * 
 */
@SuppressWarnings("all")
public final class XWinningHorizontalQuerySpecification extends BaseGeneratedEMFQuerySpecification<XWinningHorizontalMatcher> {
  private XWinningHorizontalQuerySpecification() {
   ...
   * 
   */
  public static XWinningHorizontalQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected XWinningHorizontalMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return XWinningHorizontalMatcher.on(engine);
  }
  
  @Override
  public XWinningHorizontalMatcher instantiate() throws ViatraQueryException {
    return XWinningHorizontalMatcher.create();
  }
  
  @Override
  public XWinningHorizontalMatch newEmptyMatch() {
    return XWinningHorizontalMatch.newEmptyMatch();
  }
  
  @Override
  public XWinningHorizontalMatch newMatch(final Object... parameters) {
    return XWinningHorizontalMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link XWinningHorizontalQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link XWinningHorizontalQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static XWinningHorizontalQuerySpecification INSTANCE = new XWinningHorizontalQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static XWinningHorizontalQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.XWinningHorizontal";
    }
      ...
      try {
      	{
      		...
      		new Equality(body, var_cntEast, var__virtual_1_);
      		...
      		new Equality(body, var_cntWest, var__virtual_2_);
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public String getShortDescription() {
      		        return "Expression evaluation from pattern XWinningHorizontal";
      		    }
      		    ...
      		    public Object evaluateExpression(IValueProvider provider) throws Exception {
      		        ...
      		        return evaluateExpression_1_1(cntEast, cntWest);
      		    }
      		},  null); 
  ...
  private static boolean evaluateExpression_1_1(final Integer cntEast, final Integer cntWest) {
    return (((cntEast).intValue() + (cntWest).intValue()) == 2);
  }
}
