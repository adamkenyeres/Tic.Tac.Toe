...
/**
 * A pattern-specific query specification that can instantiate TCSouthWestMatcher in a type-safe way.
 * 
 * @see TCSouthWestMatcher
 * @see TCSouthWestMatch
 * 
 */
@SuppressWarnings("all")
public final class TCSouthWestQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCSouthWestMatcher> {
  private TCSouthWestQuerySpecification() {
   ...
   * 
   */
  public static TCSouthWestQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCSouthWestMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCSouthWestMatcher.on(engine);
  }
  
  @Override
  public TCSouthWestMatcher instantiate() throws ViatraQueryException {
    return TCSouthWestMatcher.create();
  }
  
  @Override
  public TCSouthWestMatch newEmptyMatch() {
    return TCSouthWestMatch.newEmptyMatch();
  }
  
  @Override
  public TCSouthWestMatch newMatch(final Object... parameters) {
    return TCSouthWestMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCSouthWestQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCSouthWestQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCSouthWestQuerySpecification INSTANCE = new TCSouthWestQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCSouthWestQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
