...
/**
 * A match processor tailored for the queries.markCenter pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class MarkCenterProcessor implements IMatchProcessor<MarkCenterMatch> {
  /**
  ...
  @Override
  public void process(final MarkCenterMatch match) {
