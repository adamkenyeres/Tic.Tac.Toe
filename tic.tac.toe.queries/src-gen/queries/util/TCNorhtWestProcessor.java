...
/**
 * A match processor tailored for the queries.TCNorhtWest pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCNorhtWestProcessor implements IMatchProcessor<TCNorhtWestMatch> {
  /**
  ...
  @Override
  public void process(final TCNorhtWestMatch match) {
