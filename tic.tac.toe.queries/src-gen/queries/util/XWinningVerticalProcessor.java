...
/**
 * A match processor tailored for the queries.XWinningVertical pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class XWinningVerticalProcessor implements IMatchProcessor<XWinningVerticalMatch> {
  /**
  ...
  @Override
  public void process(final XWinningVerticalMatch match) {
