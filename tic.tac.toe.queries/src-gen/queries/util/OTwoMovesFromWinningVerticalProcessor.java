...
/**
 * A match processor tailored for the queries.OTwoMovesFromWinningVertical pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class OTwoMovesFromWinningVerticalProcessor implements IMatchProcessor<OTwoMovesFromWinningVerticalMatch> {
  /**
  ...
  @Override
  public void process(final OTwoMovesFromWinningVerticalMatch match) {
