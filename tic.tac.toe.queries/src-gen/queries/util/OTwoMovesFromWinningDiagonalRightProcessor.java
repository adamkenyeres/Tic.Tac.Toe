...
/**
 * A match processor tailored for the queries.OTwoMovesFromWinningDiagonalRight pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class OTwoMovesFromWinningDiagonalRightProcessor implements IMatchProcessor<OTwoMovesFromWinningDiagonalRightMatch> {
  /**
  ...
  @Override
  public void process(final OTwoMovesFromWinningDiagonalRightMatch match) {
