...
/**
 * A pattern-specific query specification that can instantiate OForkMatcher in a type-safe way.
 * 
 * @see OForkMatcher
 * @see OForkMatch
 * 
...
public final class OForkQuerySpecification extends BaseGeneratedEMFQuerySpecification<OForkMatcher> {
  private OForkQuerySpecification() {
   ...
   * 
   */
  public static OForkQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected OForkMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return OForkMatcher.on(engine);
  }
  
  @Override
  public OForkMatcher instantiate() throws ViatraQueryException {
    return OForkMatcher.create();
  }
  
  @Override
  public OForkMatch newEmptyMatch() {
    return OForkMatch.newEmptyMatch();
  }
  
  @Override
  public OForkMatch newMatch(final Object... parameters) {
    return OForkMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OForkQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link OForkQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static OForkQuerySpecification INSTANCE = new OForkQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static OForkQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		new PatternMatchCounter(body, new FlatTuple(var_square, var___5_), TCNorthQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_8_);
      		new Equality(body, var_cntNorthSquares, var__virtual_8_);
      		// 	cntSouthSquares == count find TCSouth(square, _)
      		PVariable var__virtual_9_ = body.getOrCreateVariableByName(".virtual{9}");
      		new PatternMatchCounter(body, new FlatTuple(var_square, var___6_), TCSouthQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_9_);
      		new Equality(body, var_cntSouthSquares, var__virtual_9_);
      		// 	cntEastSquares == count find TCEast(square, _)
      		PVariable var__virtual_10_ = body.getOrCreateVariableByName(".virtual{10}");
      		new PatternMatchCounter(body, new FlatTuple(var_square, var___7_), TCEastQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_10_);
      		new Equality(body, var_cntEastSquares, var__virtual_10_);
      		// 	cntWestSquares == count find TCWest(square, _)
      		PVariable var__virtual_11_ = body.getOrCreateVariableByName(".virtual{11}");
      		new PatternMatchCounter(body, new FlatTuple(var_square, var___8_), TCWestQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_11_);
      		new Equality(body, var_cntWestSquares, var__virtual_11_);
      		// 	check(cntNorthSquares + cntSouthSquares == 2)
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		
      		    @Override
      		    public String getShortDescription() {
      		        return "Expression evaluation from pattern OFork";
      		    }
      		    ...
      		    public Object evaluateExpression(IValueProvider provider) throws Exception {
      		        ...
      		        return evaluateExpression_1_1(cntNorthSquares, cntSouthSquares);
      		    }
      		},  null); 
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public Object evaluateExpression(IValueProvider provider) throws Exception {
      		        ...
      		        return evaluateExpression_1_2(cntEastSquares, cntWestSquares);
      		    }
      		},  null); 
      		...
      		new PatternMatchCounter(body, new FlatTuple(var_square, var___11_, var_colorO), TCEastWithSameMarksQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_14_);
      		new Equality(body, var_cntOEast, var__virtual_14_);
      		...
      		new PatternMatchCounter(body, new FlatTuple(var_square, var___12_, var_colorO), TCWestWithSameMarksQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_15_);
      		new Equality(body, var_cntOWest, var__virtual_15_);
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public Object evaluateExpression(IValueProvider provider) throws Exception {
      		        ...
      		        return evaluateExpression_1_3(cntXNorth, cntXSouth);
      		    }
      		},  null); 
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public Object evaluateExpression(IValueProvider provider) throws Exception {
      		        ...
      		        return evaluateExpression_1_4(cntONorth, cntOSouth);
      		    }
      		},  null); 
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public Object evaluateExpression(IValueProvider provider) throws Exception {
      		        ...
      		        return evaluateExpression_1_5(cntXEast, cntXWest);
      		    }
      		},  null); 
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public Object evaluateExpression(IValueProvider provider) throws Exception {
      		        ...
      		        return evaluateExpression_1_6(cntOEast, cntOWest);
      		    }
      		},  null); 
      		bodies.add(body);
      	}
  ...
  private static boolean evaluateExpression_1_1(final Integer cntNorthSquares, final Integer cntSouthSquares) {
    return (((cntNorthSquares).intValue() + (cntSouthSquares).intValue()) == 2);
  }
  
  private static boolean evaluateExpression_1_2(final Integer cntEastSquares, final Integer cntWestSquares) {
    return (((cntEastSquares).intValue() + (cntWestSquares).intValue()) == 2);
  }
  
  private static boolean evaluateExpression_1_3(final Integer cntXNorth, final Integer cntXSouth) {
    return (((cntXNorth).intValue() + (cntXSouth).intValue()) == 0);
  }
  
  private static boolean evaluateExpression_1_4(final Integer cntONorth, final Integer cntOSouth) {
    return (((cntONorth).intValue() + (cntOSouth).intValue()) >= 1);
  }
  
  private static boolean evaluateExpression_1_5(final Integer cntXEast, final Integer cntXWest) {
    return (((cntXEast).intValue() + (cntXWest).intValue()) == 0);
  }
  
  private static boolean evaluateExpression_1_6(final Integer cntOEast, final Integer cntOWest) {
  ...
  private static boolean evaluateExpression_3_4(final Integer cntXNE, final Integer cntXSW) {
    return (((cntXNE).intValue() + (cntXSW).intValue()) == 0);
  }
  ...
  private static boolean evaluateExpression_4_3(final Integer cntXEast, final Integer cntXWest) {
    return (((cntXWest).intValue() + (cntXEast).intValue()) == 0);
  }
