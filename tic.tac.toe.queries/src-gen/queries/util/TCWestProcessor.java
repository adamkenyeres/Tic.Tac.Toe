...
/**
 * A match processor tailored for the queries.TCWest pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCWestProcessor implements IMatchProcessor<TCWestMatch> {
  /**
  ...
  @Override
  public void process(final TCWestMatch match) {
