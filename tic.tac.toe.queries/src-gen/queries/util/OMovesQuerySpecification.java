...
/**
 * A pattern-specific query specification that can instantiate OMovesMatcher in a type-safe way.
 * 
 * @see OMovesMatcher
 * @see OMovesMatch
 * 
...
public final class OMovesQuerySpecification extends BaseGeneratedEMFQuerySpecification<OMovesMatcher> {
  private OMovesQuerySpecification() {
   ...
   * 
   */
  public static OMovesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected OMovesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return OMovesMatcher.on(engine);
  }
  
  @Override
  public OMovesMatcher instantiate() throws ViatraQueryException {
    return OMovesMatcher.create();
  }
  
  @Override
  public OMovesMatch newEmptyMatch() {
    return OMovesMatch.newEmptyMatch();
  }
  
  @Override
  public OMovesMatch newMatch(final Object... parameters) {
    return OMovesMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OMovesQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link OMovesQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static OMovesQuerySpecification INSTANCE = new OMovesQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static OMovesQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
