...
/**
 * A pattern-specific query specification that can instantiate TCSouthWithSameMarksMatcher in a type-safe way.
 * 
 * @see TCSouthWithSameMarksMatcher
 * @see TCSouthWithSameMarksMatch
 * 
 */
@SuppressWarnings("all")
public final class TCSouthWithSameMarksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCSouthWithSameMarksMatcher> {
  private TCSouthWithSameMarksQuerySpecification() {
   ...
   * 
   */
  public static TCSouthWithSameMarksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCSouthWithSameMarksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCSouthWithSameMarksMatcher.on(engine);
  }
  
  @Override
  public TCSouthWithSameMarksMatcher instantiate() throws ViatraQueryException {
    return TCSouthWithSameMarksMatcher.create();
  }
  
  @Override
  public TCSouthWithSameMarksMatch newEmptyMatch() {
    return TCSouthWithSameMarksMatch.newEmptyMatch();
  }
  
  @Override
  public TCSouthWithSameMarksMatch newMatch(final Object... parameters) {
    return TCSouthWithSameMarksMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCSouthWithSameMarksQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCSouthWithSameMarksQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCSouthWithSameMarksQuerySpecification INSTANCE = new TCSouthWithSameMarksQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCSouthWithSameMarksQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.TCSouthWithSameMarks";
    }
