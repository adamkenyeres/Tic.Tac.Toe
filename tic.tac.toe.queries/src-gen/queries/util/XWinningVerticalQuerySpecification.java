...
/**
 * A pattern-specific query specification that can instantiate XWinningVerticalMatcher in a type-safe way.
 * 
...
public final class XWinningVerticalQuerySpecification extends BaseGeneratedEMFQuerySpecification<XWinningVerticalMatcher> {
  private XWinningVerticalQuerySpecification() {
   ...
   * 
   */
  public static XWinningVerticalQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected XWinningVerticalMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return XWinningVerticalMatcher.on(engine);
  }
  
  @Override
  public XWinningVerticalMatcher instantiate() throws ViatraQueryException {
    return XWinningVerticalMatcher.create();
  }
  
  @Override
  public XWinningVerticalMatch newEmptyMatch() {
    return XWinningVerticalMatch.newEmptyMatch();
  }
  
  @Override
  public XWinningVerticalMatch newMatch(final Object... parameters) {
    return XWinningVerticalMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link XWinningVerticalQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link XWinningVerticalQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static XWinningVerticalQuerySpecification INSTANCE = new XWinningVerticalQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static XWinningVerticalQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public String getShortDescription() {
      		        return "Expression evaluation from pattern XWinningVertical";
      		    }
