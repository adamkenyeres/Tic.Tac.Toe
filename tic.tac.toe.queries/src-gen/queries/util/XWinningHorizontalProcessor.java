...
/**
 * A match processor tailored for the queries.XWinningHorizontal pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class XWinningHorizontalProcessor implements IMatchProcessor<XWinningHorizontalMatch> {
  /**
  ...
  @Override
  public void process(final XWinningHorizontalMatch match) {
