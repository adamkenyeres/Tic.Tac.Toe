...
/**
 * A match processor tailored for the queries.corners pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class CornersProcessor implements IMatchProcessor<CornersMatch> {
  /**
  ...
  @Override
  public void process(final CornersMatch match) {
