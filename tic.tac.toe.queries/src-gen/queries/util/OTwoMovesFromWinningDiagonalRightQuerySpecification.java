...
/**
 * A pattern-specific query specification that can instantiate OTwoMovesFromWinningDiagonalRightMatcher in a type-safe way.
 * 
 * @see OTwoMovesFromWinningDiagonalRightMatcher
 * @see OTwoMovesFromWinningDiagonalRightMatch
 * 
 */
@SuppressWarnings("all")
public final class OTwoMovesFromWinningDiagonalRightQuerySpecification extends BaseGeneratedEMFQuerySpecification<OTwoMovesFromWinningDiagonalRightMatcher> {
  private OTwoMovesFromWinningDiagonalRightQuerySpecification() {
   ...
   * 
   */
  public static OTwoMovesFromWinningDiagonalRightQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected OTwoMovesFromWinningDiagonalRightMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return OTwoMovesFromWinningDiagonalRightMatcher.on(engine);
  }
  
  @Override
  public OTwoMovesFromWinningDiagonalRightMatcher instantiate() throws ViatraQueryException {
    return OTwoMovesFromWinningDiagonalRightMatcher.create();
  }
  
  @Override
  public OTwoMovesFromWinningDiagonalRightMatch newEmptyMatch() {
    return OTwoMovesFromWinningDiagonalRightMatch.newEmptyMatch();
  }
  
  @Override
  public OTwoMovesFromWinningDiagonalRightMatch newMatch(final Object... parameters) {
    return OTwoMovesFromWinningDiagonalRightMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OTwoMovesFromWinningDiagonalRightQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link OTwoMovesFromWinningDiagonalRightQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static OTwoMovesFromWinningDiagonalRightQuerySpecification INSTANCE = new OTwoMovesFromWinningDiagonalRightQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static OTwoMovesFromWinningDiagonalRightQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.OTwoMovesFromWinningDiagonalRight";
    }
      ...
      try {
      	{
      		...
      		new Equality(body, var_cntONE, var__virtual_1_);
      		...
      		new Equality(body, var_cntOSW, var__virtual_2_);
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public String getShortDescription() {
      		        return "Expression evaluation from pattern OTwoMovesFromWinningDiagonalRight";
      		    }
      		    ...
      		    public Object evaluateExpression(IValueProvider provider) throws Exception {
      		        ...
      		        return evaluateExpression_1_1(cntONE, cntOSW);
      		    }
      		},  null); 
      		...
      		new PatternMatchCounter(body, new FlatTuple(var_square, var___3_, var_colorX), TCNorthEastWithSameMarksQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_6_);
      		new Equality(body, var_cntXNE, var__virtual_6_);
      		// 	cntXSW == count find TCSouthWestWithSameMarks(square, _, colorX)
      		PVariable var__virtual_7_ = body.getOrCreateVariableByName(".virtual{7}");
      		new PatternMatchCounter(body, new FlatTuple(var_square, var___4_, var_colorX), TCSouthWestWithSameMarksQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_7_);
      		new Equality(body, var_cntXSW, var__virtual_7_);
      		// 	neg find markOnSquare(_, square, engine)
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public Object evaluateExpression(IValueProvider provider) throws Exception {
      		        ...
      		        return evaluateExpression_1_2(cntXNE, cntXSW);
      		    }
      		},  null); 
  ...
  private static boolean evaluateExpression_1_1(final Integer cntONE, final Integer cntOSW) {
    return (((cntONE).intValue() + (cntOSW).intValue()) == 1);
  }
  
  private static boolean evaluateExpression_1_2(final Integer cntXNE, final Integer cntXSW) {
