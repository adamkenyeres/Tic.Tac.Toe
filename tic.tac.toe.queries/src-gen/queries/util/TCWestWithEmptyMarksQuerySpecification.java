...
/**
 * A pattern-specific query specification that can instantiate TCWestWithEmptyMarksMatcher in a type-safe way.
 * 
...
public final class TCWestWithEmptyMarksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCWestWithEmptyMarksMatcher> {
  private TCWestWithEmptyMarksQuerySpecification() {
   ...
   * 
   */
  public static TCWestWithEmptyMarksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCWestWithEmptyMarksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCWestWithEmptyMarksMatcher.on(engine);
  }
  
  @Override
  public TCWestWithEmptyMarksMatcher instantiate() throws ViatraQueryException {
    return TCWestWithEmptyMarksMatcher.create();
  }
  
  @Override
  public TCWestWithEmptyMarksMatch newEmptyMatch() {
    return TCWestWithEmptyMarksMatch.newEmptyMatch();
  }
  
  @Override
  public TCWestWithEmptyMarksMatch newMatch(final Object... parameters) {
    return TCWestWithEmptyMarksMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Engine) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCWestWithEmptyMarksQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCWestWithEmptyMarksQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCWestWithEmptyMarksQuerySpecification INSTANCE = new TCWestWithEmptyMarksQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCWestWithEmptyMarksQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
