...
/**
 * A match processor tailored for the queries.TCEastWithEmptyMarks pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCEastWithEmptyMarksProcessor implements IMatchProcessor<TCEastWithEmptyMarksMatch> {
  /**
  ...
  @Override
  public void process(final TCEastWithEmptyMarksMatch match) {
