...
public final class NWQuerySpecification extends BaseGeneratedEMFQuerySpecification<NWMatcher> {
  ...
  @Override
  public NWMatcher instantiate() throws ViatraQueryException {
    return NWMatcher.create();
  }
  ...
  public NWMatch newMatch(final Object... parameters) {
    return NWMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1]);
  }
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_target, var_source, var___0_), SouthEastQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	{
