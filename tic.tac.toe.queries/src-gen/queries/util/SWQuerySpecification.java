...
public final class SWQuerySpecification extends BaseGeneratedEMFQuerySpecification<SWMatcher> {
  ...
  @Override
  public SWMatcher instantiate() throws ViatraQueryException {
    return SWMatcher.create();
  }
  ...
  public SWMatch newMatch(final Object... parameters) {
    return SWMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1]);
  }
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_source, var_target, var___0_), SouthWestQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	{
