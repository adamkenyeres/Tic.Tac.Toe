...
/**
 * A match processor tailored for the queries.TCEastWithSameMarks pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCEastWithSameMarksProcessor implements IMatchProcessor<TCEastWithSameMarksMatch> {
  /**
  ...
  @Override
  public void process(final TCEastWithSameMarksMatch match) {
