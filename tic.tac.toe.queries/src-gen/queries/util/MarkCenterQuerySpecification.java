...
/**
 * A pattern-specific query specification that can instantiate MarkCenterMatcher in a type-safe way.
 * 
 * @see MarkCenterMatcher
 * @see MarkCenterMatch
 * 
 */
@SuppressWarnings("all")
public final class MarkCenterQuerySpecification extends BaseGeneratedEMFQuerySpecification<MarkCenterMatcher> {
  private MarkCenterQuerySpecification() {
   ...
   * 
   */
  public static MarkCenterQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected MarkCenterMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return MarkCenterMatcher.on(engine);
  }
  
  @Override
  public MarkCenterMatcher instantiate() throws ViatraQueryException {
    return MarkCenterMatcher.create();
  }
  
  @Override
  public MarkCenterMatch newEmptyMatch() {
    return MarkCenterMatch.newEmptyMatch();
  }
  
  @Override
  public MarkCenterMatch newMatch(final Object... parameters) {
    return MarkCenterMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MarkCenterQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link MarkCenterQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static MarkCenterQuerySpecification INSTANCE = new MarkCenterQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static MarkCenterQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_square, var__virtual_2_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://example.com/tictactoe", "Square", "pos_x")));
      		...
      		new TypeConstraint(body, new FlatTuple(var_square, var__virtual_4_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://example.com/tictactoe", "Square", "pos_y")));
