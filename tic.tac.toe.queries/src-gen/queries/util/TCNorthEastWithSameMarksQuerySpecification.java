...
/**
 * A pattern-specific query specification that can instantiate TCNorthEastWithSameMarksMatcher in a type-safe way.
 * 
...
public final class TCNorthEastWithSameMarksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCNorthEastWithSameMarksMatcher> {
  private TCNorthEastWithSameMarksQuerySpecification() {
   ...
   * 
   */
  public static TCNorthEastWithSameMarksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCNorthEastWithSameMarksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCNorthEastWithSameMarksMatcher.on(engine);
  }
  
  @Override
  public TCNorthEastWithSameMarksMatcher instantiate() throws ViatraQueryException {
    return TCNorthEastWithSameMarksMatcher.create();
  }
  
  @Override
  public TCNorthEastWithSameMarksMatch newEmptyMatch() {
    return TCNorthEastWithSameMarksMatch.newEmptyMatch();
  }
  
  @Override
  public TCNorthEastWithSameMarksMatch newMatch(final Object... parameters) {
    return TCNorthEastWithSameMarksMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCNorthEastWithSameMarksQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCNorthEastWithSameMarksQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCNorthEastWithSameMarksQuerySpecification INSTANCE = new TCNorthEastWithSameMarksQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCNorthEastWithSameMarksQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		// 	find NE +(s1, s2)
      		new BinaryTransitiveClosure(body, new FlatTuple(var_s1, var_s2), NEQuerySpecification.instance().getInternalQueryRepresentation());
