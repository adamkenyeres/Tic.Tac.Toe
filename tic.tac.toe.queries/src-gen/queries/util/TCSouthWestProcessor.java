...
/**
 * A match processor tailored for the queries.TCSouthWest pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCSouthWestProcessor implements IMatchProcessor<TCSouthWestMatch> {
  /**
  ...
  @Override
  public void process(final TCSouthWestMatch match) {
