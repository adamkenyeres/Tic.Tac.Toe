...
/**
 * A pattern-specific query specification that can instantiate TCNorthWithEmptyMarksMatcher in a type-safe way.
 * 
 * @see TCNorthWithEmptyMarksMatcher
 * @see TCNorthWithEmptyMarksMatch
 * 
 */
@SuppressWarnings("all")
public final class TCNorthWithEmptyMarksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCNorthWithEmptyMarksMatcher> {
  private TCNorthWithEmptyMarksQuerySpecification() {
   ...
   * 
   */
  public static TCNorthWithEmptyMarksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCNorthWithEmptyMarksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCNorthWithEmptyMarksMatcher.on(engine);
  }
  
  @Override
  public TCNorthWithEmptyMarksMatcher instantiate() throws ViatraQueryException {
    return TCNorthWithEmptyMarksMatcher.create();
  }
  
  @Override
  public TCNorthWithEmptyMarksMatch newEmptyMatch() {
    return TCNorthWithEmptyMarksMatch.newEmptyMatch();
  }
  
  @Override
  public TCNorthWithEmptyMarksMatch newMatch(final Object... parameters) {
    return TCNorthWithEmptyMarksMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Engine) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCNorthWithEmptyMarksQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCNorthWithEmptyMarksQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCNorthWithEmptyMarksQuerySpecification INSTANCE = new TCNorthWithEmptyMarksQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCNorthWithEmptyMarksQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.TCNorthWithEmptyMarks";
    }
      ...
      try {
      	{
      		...
      		// 	find TCNorth(s1, s2)
      		new PositivePatternCall(body, new FlatTuple(var_s1, var_s2), TCNorthQuerySpecification.instance().getInternalQueryRepresentation());
