...
/**
 * A match processor tailored for the queries.OWinning pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class OWinningProcessor implements IMatchProcessor<OWinningMatch> {
  /**
  ...
  @Override
  public void process(final OWinningMatch match) {
