...
/**
 * A match processor tailored for the queries.TCWestWithSameMarks pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCWestWithSameMarksProcessor implements IMatchProcessor<TCWestWithSameMarksMatch> {
  /**
  ...
  @Override
  public void process(final TCWestWithSameMarksMatch match) {
