...
/**
 * A pattern-specific query specification that can instantiate TCSouthWithEmptyMarksMatcher in a type-safe way.
 * 
 * @see TCSouthWithEmptyMarksMatcher
 * @see TCSouthWithEmptyMarksMatch
 * 
 */
@SuppressWarnings("all")
public final class TCSouthWithEmptyMarksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCSouthWithEmptyMarksMatcher> {
  private TCSouthWithEmptyMarksQuerySpecification() {
   ...
   * 
   */
  public static TCSouthWithEmptyMarksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCSouthWithEmptyMarksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCSouthWithEmptyMarksMatcher.on(engine);
  }
  
  @Override
  public TCSouthWithEmptyMarksMatcher instantiate() throws ViatraQueryException {
    return TCSouthWithEmptyMarksMatcher.create();
  }
  
  @Override
  public TCSouthWithEmptyMarksMatch newEmptyMatch() {
    return TCSouthWithEmptyMarksMatch.newEmptyMatch();
  }
  
  @Override
  public TCSouthWithEmptyMarksMatch newMatch(final Object... parameters) {
    return TCSouthWithEmptyMarksMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Engine) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCSouthWithEmptyMarksQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCSouthWithEmptyMarksQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCSouthWithEmptyMarksQuerySpecification INSTANCE = new TCSouthWithEmptyMarksQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCSouthWithEmptyMarksQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.TCSouthWithEmptyMarks";
    }
      ...
      try {
      	{
      		...
      		// 	find TCSouth(s1, s2)
      		new PositivePatternCall(body, new FlatTuple(var_s1, var_s2), TCSouthQuerySpecification.instance().getInternalQueryRepresentation());
