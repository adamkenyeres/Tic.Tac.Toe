...
/**
 * A pattern-specific query specification that can instantiate OTwoMovesFromWinningMatcher in a type-safe way.
 * 
...
public final class OTwoMovesFromWinningQuerySpecification extends BaseGeneratedEMFQuerySpecification<OTwoMovesFromWinningMatcher> {
  private OTwoMovesFromWinningQuerySpecification() {
   ...
   * 
   */
  public static OTwoMovesFromWinningQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected OTwoMovesFromWinningMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return OTwoMovesFromWinningMatcher.on(engine);
  }
  
  @Override
  public OTwoMovesFromWinningMatcher instantiate() throws ViatraQueryException {
    return OTwoMovesFromWinningMatcher.create();
  }
  
  @Override
  public OTwoMovesFromWinningMatch newEmptyMatch() {
    return OTwoMovesFromWinningMatch.newEmptyMatch();
  }
  
  @Override
  public OTwoMovesFromWinningMatch newMatch(final Object... parameters) {
    return OTwoMovesFromWinningMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OTwoMovesFromWinningQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link OTwoMovesFromWinningQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static OTwoMovesFromWinningQuerySpecification INSTANCE = new OTwoMovesFromWinningQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static OTwoMovesFromWinningQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_square, var_engine, var_color), OTwoMovesFromWinningHorizontalQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	{
      		PBody body = new PBody(this);
      		...
      		// //	find OTwoMovesFromWinningDiagonalRight(square, engine, color);//} or {//	find OTwoMovesFromWinningDiagonalLeft(square, engine, color);//}or{	find OTwoMovesFromWinningVertical(square, engine, color)
      		new PositivePatternCall(body, new FlatTuple(var_square, var_engine, var_color), OTwoMovesFromWinningVerticalQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
