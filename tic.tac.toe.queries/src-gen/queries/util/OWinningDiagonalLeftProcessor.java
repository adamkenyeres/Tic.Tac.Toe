...
/**
 * A match processor tailored for the queries.OWinningDiagonalLeft pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class OWinningDiagonalLeftProcessor implements IMatchProcessor<OWinningDiagonalLeftMatch> {
  /**
  ...
  @Override
  public void process(final OWinningDiagonalLeftMatch match) {
