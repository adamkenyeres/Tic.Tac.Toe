...
/**
 * A match processor tailored for the queries.OWinningHorizontal pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class OWinningHorizontalProcessor implements IMatchProcessor<OWinningHorizontalMatch> {
  /**
  ...
  @Override
  public void process(final OWinningHorizontalMatch match) {
