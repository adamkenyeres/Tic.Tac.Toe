...
/**
 * A match processor tailored for the queries.OTwoMovesFromWinningDiagonalLeft pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class OTwoMovesFromWinningDiagonalLeftProcessor implements IMatchProcessor<OTwoMovesFromWinningDiagonalLeftMatch> {
  /**
  ...
  @Override
  public void process(final OTwoMovesFromWinningDiagonalLeftMatch match) {
