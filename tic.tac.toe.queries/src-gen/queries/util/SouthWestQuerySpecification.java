...
/**
 * A pattern-specific query specification that can instantiate SouthWestMatcher in a type-safe way.
 * 
...
public final class SouthWestQuerySpecification extends BaseGeneratedEMFQuerySpecification<SouthWestMatcher> {
  private SouthWestQuerySpecification() {
   ...
   * 
   */
  public static SouthWestQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected SouthWestMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return SouthWestMatcher.on(engine);
  }
  
  @Override
  public SouthWestMatcher instantiate() throws ViatraQueryException {
    return SouthWestMatcher.create();
  }
  
  @Override
  public SouthWestMatch newEmptyMatch() {
    return SouthWestMatch.newEmptyMatch();
  }
  
  @Override
  public SouthWestMatch newMatch(final Object... parameters) {
    return SouthWestMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Engine) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SouthWestQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link SouthWestQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static SouthWestQuerySpecification INSTANCE = new SouthWestQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static SouthWestQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public String getShortDescription() {
      		        return "Expression evaluation from pattern SouthWest";
      		    }
  ...
  private static boolean evaluateExpression_1_2(final Integer pos_N_x, final Integer pos_S_x) {
    return ((pos_N_x).intValue() == ((pos_S_x).intValue() + 1));
  }
}
