...
/**
 * A pattern-specific query specification that can instantiate OWinningDiagonalRightMatcher in a type-safe way.
 * 
 * @see OWinningDiagonalRightMatcher
 * @see OWinningDiagonalRightMatch
 * 
 */
@SuppressWarnings("all")
public final class OWinningDiagonalRightQuerySpecification extends BaseGeneratedEMFQuerySpecification<OWinningDiagonalRightMatcher> {
  private OWinningDiagonalRightQuerySpecification() {
   ...
   * 
   */
  public static OWinningDiagonalRightQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected OWinningDiagonalRightMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return OWinningDiagonalRightMatcher.on(engine);
  }
  
  @Override
  public OWinningDiagonalRightMatcher instantiate() throws ViatraQueryException {
    return OWinningDiagonalRightMatcher.create();
  }
  
  @Override
  public OWinningDiagonalRightMatch newEmptyMatch() {
    return OWinningDiagonalRightMatch.newEmptyMatch();
  }
  
  @Override
  public OWinningDiagonalRightMatch newMatch(final Object... parameters) {
    return OWinningDiagonalRightMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OWinningDiagonalRightQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link OWinningDiagonalRightQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static OWinningDiagonalRightQuerySpecification INSTANCE = new OWinningDiagonalRightQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static OWinningDiagonalRightQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.OWinningDiagonalRight";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		    ...
      		    public String getShortDescription() {
      		        return "Expression evaluation from pattern OWinningDiagonalRight";
      		    }
