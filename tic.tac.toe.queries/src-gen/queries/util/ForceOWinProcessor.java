...
/**
 * A match processor tailored for the queries.forceOWin pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ForceOWinProcessor implements IMatchProcessor<ForceOWinMatch> {
  /**
  ...
  @Override
  public void process(final ForceOWinMatch match) {
