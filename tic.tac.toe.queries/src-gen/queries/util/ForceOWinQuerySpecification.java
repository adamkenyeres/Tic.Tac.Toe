...
/**
 * A pattern-specific query specification that can instantiate ForceOWinMatcher in a type-safe way.
 * 
 * @see ForceOWinMatcher
 * @see ForceOWinMatch
 * 
 */
@SuppressWarnings("all")
public final class ForceOWinQuerySpecification extends BaseGeneratedEMFQuerySpecification<ForceOWinMatcher> {
  private ForceOWinQuerySpecification() {
   ...
   * 
   */
  public static ForceOWinQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected ForceOWinMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return ForceOWinMatcher.on(engine);
  }
  
  @Override
  public ForceOWinMatcher instantiate() throws ViatraQueryException {
    return ForceOWinMatcher.create();
  }
  
  @Override
  public ForceOWinMatch newEmptyMatch() {
    return ForceOWinMatch.newEmptyMatch();
  }
  
  @Override
  public ForceOWinMatch newMatch(final Object... parameters) {
    return ForceOWinMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ForceOWinQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link ForceOWinQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static ForceOWinQuerySpecification INSTANCE = new ForceOWinQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ForceOWinQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_square, var_engine, var_color), OTwoMovesFromWinningQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
