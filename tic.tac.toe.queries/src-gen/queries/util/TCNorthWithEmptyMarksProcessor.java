...
/**
 * A match processor tailored for the queries.TCNorthWithEmptyMarks pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCNorthWithEmptyMarksProcessor implements IMatchProcessor<TCNorthWithEmptyMarksMatch> {
  /**
  ...
  @Override
  public void process(final TCNorthWithEmptyMarksMatch match) {
