...
/**
 * A match processor tailored for the queries.TCSouthEast pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCSouthEastProcessor implements IMatchProcessor<TCSouthEastMatch> {
  /**
  ...
  @Override
  public void process(final TCSouthEastMatch match) {
