...
/**
 * A pattern-specific query specification that can instantiate TCNorthWestWithSameMarksMatcher in a type-safe way.
 * 
 * @see TCNorthWestWithSameMarksMatcher
 * @see TCNorthWestWithSameMarksMatch
 * 
 */
@SuppressWarnings("all")
public final class TCNorthWestWithSameMarksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCNorthWestWithSameMarksMatcher> {
  private TCNorthWestWithSameMarksQuerySpecification() {
   ...
   * 
   */
  public static TCNorthWestWithSameMarksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCNorthWestWithSameMarksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCNorthWestWithSameMarksMatcher.on(engine);
  }
  
  @Override
  public TCNorthWestWithSameMarksMatcher instantiate() throws ViatraQueryException {
    return TCNorthWestWithSameMarksMatcher.create();
  }
  
  @Override
  public TCNorthWestWithSameMarksMatch newEmptyMatch() {
    return TCNorthWestWithSameMarksMatch.newEmptyMatch();
  }
  
  @Override
  public TCNorthWestWithSameMarksMatch newMatch(final Object... parameters) {
    return TCNorthWestWithSameMarksMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCNorthWestWithSameMarksQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCNorthWestWithSameMarksQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCNorthWestWithSameMarksQuerySpecification INSTANCE = new TCNorthWestWithSameMarksQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCNorthWestWithSameMarksQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.TCNorthWestWithSameMarks";
    }
