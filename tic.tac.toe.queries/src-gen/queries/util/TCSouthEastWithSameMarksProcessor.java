...
/**
 * A match processor tailored for the queries.TCSouthEastWithSameMarks pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TCSouthEastWithSameMarksProcessor implements IMatchProcessor<TCSouthEastWithSameMarksMatch> {
  /**
  ...
  @Override
  public void process(final TCSouthEastWithSameMarksMatch match) {
