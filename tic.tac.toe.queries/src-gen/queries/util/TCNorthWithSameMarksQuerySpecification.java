...
/**
 * A pattern-specific query specification that can instantiate TCNorthWithSameMarksMatcher in a type-safe way.
 * 
 * @see TCNorthWithSameMarksMatcher
 * @see TCNorthWithSameMarksMatch
 * 
 */
@SuppressWarnings("all")
public final class TCNorthWithSameMarksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TCNorthWithSameMarksMatcher> {
  private TCNorthWithSameMarksQuerySpecification() {
   ...
   * 
   */
  public static TCNorthWithSameMarksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TCNorthWithSameMarksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TCNorthWithSameMarksMatcher.on(engine);
  }
  
  @Override
  public TCNorthWithSameMarksMatcher instantiate() throws ViatraQueryException {
    return TCNorthWithSameMarksMatcher.create();
  }
  
  @Override
  public TCNorthWithSameMarksMatch newEmptyMatch() {
    return TCNorthWithSameMarksMatch.newEmptyMatch();
  }
  
  @Override
  public TCNorthWithSameMarksMatch newMatch(final Object... parameters) {
    return TCNorthWithSameMarksMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Square) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TCNorthWithSameMarksQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TCNorthWithSameMarksQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TCNorthWithSameMarksQuerySpecification INSTANCE = new TCNorthWithSameMarksQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TCNorthWithSameMarksQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "queries.TCNorthWithSameMarks";
    }
