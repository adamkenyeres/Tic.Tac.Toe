...
/**
 * A pattern-specific query specification that can instantiate OWinningMatcher in a type-safe way.
 * 
 * @see OWinningMatcher
 * @see OWinningMatch
 * 
...
public final class OWinningQuerySpecification extends BaseGeneratedEMFQuerySpecification<OWinningMatcher> {
  private OWinningQuerySpecification() {
   ...
   * 
   */
  public static OWinningQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected OWinningMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return OWinningMatcher.on(engine);
  }
  
  @Override
  public OWinningMatcher instantiate() throws ViatraQueryException {
    return OWinningMatcher.create();
  }
  
  @Override
  public OWinningMatch newEmptyMatch() {
    return OWinningMatch.newEmptyMatch();
  }
  
  @Override
  public OWinningMatch newMatch(final Object... parameters) {
    return OWinningMatch.newMatch((tictactoe.Square) parameters[0], (tictactoe.Engine) parameters[1], (tictactoe.Color) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OWinningQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link OWinningQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static OWinningQuerySpecification INSTANCE = new OWinningQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static OWinningQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_square, var_engine, var_color), OWinningDiagonalLeftQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	{
      		PBody body = new PBody(this);
      		...
      		new PositivePatternCall(body, new FlatTuple(var_square, var_engine, var_color), OWinningDiagonalRightQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	{
      		PBody body = new PBody(this);
      		...
      		new PositivePatternCall(body, new FlatTuple(var_square, var_engine, var_color), OWinningHorizontalQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	{
      		PBody body = new PBody(this);
      		...
      		new PositivePatternCall(body, new FlatTuple(var_square, var_engine, var_color), OWinningVerticalQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
