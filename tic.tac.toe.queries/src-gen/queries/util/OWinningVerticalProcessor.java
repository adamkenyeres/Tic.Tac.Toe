...
/**
 * A match processor tailored for the queries.OWinningVertical pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class OWinningVerticalProcessor implements IMatchProcessor<OWinningVerticalMatch> {
  /**
  ...
  @Override
  public void process(final OWinningVerticalMatch match) {
