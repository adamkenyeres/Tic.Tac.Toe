...
/**
 * Pattern-specific match representation of the queries.OWinningDiagonalLeft pattern,
 * to be used in conjunction with {@link OWinningDiagonalLeftMatcher}.
 * 
...
public abstract class OWinningDiagonalLeftMatch extends BasePatternMatch {
  ...
  private OWinningDiagonalLeftMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return OWinningDiagonalLeftMatch.parameterNames;
  }
  ...
  @Override
  public OWinningDiagonalLeftMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OWinningDiagonalLeftMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OWinningDiagonalLeftMatch other = (OWinningDiagonalLeftMatch) obj;
  ...
  @Override
  public OWinningDiagonalLeftQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OWinningDiagonalLeftMatch newEmptyMatch() {
   ...
   * 
   */
  public static OWinningDiagonalLeftMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static OWinningDiagonalLeftMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends OWinningDiagonalLeftMatch {
  ...
  private static final class Immutable extends OWinningDiagonalLeftMatch {
