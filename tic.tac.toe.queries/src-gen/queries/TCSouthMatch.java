...
/**
 * Pattern-specific match representation of the queries.TCSouth pattern,
 * to be used in conjunction with {@link TCSouthMatcher}.
 * 
...
public abstract class TCSouthMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCSouthMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return TCSouthMatch.parameterNames;
  }
  ...
  @Override
  public TCSouthMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCSouthMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCSouthMatch other = (TCSouthMatch) obj;
  ...
  @Override
  public TCSouthQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCSouthMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCSouthMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static TCSouthMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends TCSouthMatch {
  ...
  private static final class Immutable extends TCSouthMatch {
