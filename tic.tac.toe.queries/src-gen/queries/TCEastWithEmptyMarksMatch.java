...
/**
 * Pattern-specific match representation of the queries.TCEastWithEmptyMarks pattern,
 * to be used in conjunction with {@link TCEastWithEmptyMarksMatcher}.
 * 
...
public abstract class TCEastWithEmptyMarksMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCEastWithEmptyMarksMatch(final Square pS1, final Square pS2, final Engine pEngine) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  ...
  public List<String> parameterNames() {
    return TCEastWithEmptyMarksMatch.parameterNames;
  }
  ...
  @Override
  public TCEastWithEmptyMarksMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCEastWithEmptyMarksMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCEastWithEmptyMarksMatch other = (TCEastWithEmptyMarksMatch) obj;
  ...
  @Override
  public TCEastWithEmptyMarksQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCEastWithEmptyMarksMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCEastWithEmptyMarksMatch newMutableMatch(final Square pS1, final Square pS2, final Engine pEngine) {
   ...
   * 
   */
  public static TCEastWithEmptyMarksMatch newMatch(final Square pS1, final Square pS2, final Engine pEngine) {
    return new Immutable(pS1, pS2, pEngine);
  }
  
  private static final class Mutable extends TCEastWithEmptyMarksMatch {
  ...
  private static final class Immutable extends TCEastWithEmptyMarksMatch {
