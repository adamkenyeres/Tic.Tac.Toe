...
/**
 * Pattern-specific match representation of the queries.oTwoMovesFromWinning pattern,
 * to be used in conjunction with {@link OTwoMovesFromWinningMatcher}.
 * 
 ...
 * 
 * @see OTwoMovesFromWinningMatcher
 * @see OTwoMovesFromWinningProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class OTwoMovesFromWinningMatch extends BasePatternMatch {
  ...
  private OTwoMovesFromWinningMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public String patternName() {
    return "queries.oTwoMovesFromWinning";
  }
  
  @Override
  public List<String> parameterNames() {
    return OTwoMovesFromWinningMatch.parameterNames;
  }
  ...
  @Override
  public OTwoMovesFromWinningMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OTwoMovesFromWinningMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OTwoMovesFromWinningMatch other = (OTwoMovesFromWinningMatch) obj;
  ...
  @Override
  public OTwoMovesFromWinningQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OTwoMovesFromWinningMatch newEmptyMatch() {
   ...
   * 
   */
  public static OTwoMovesFromWinningMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static OTwoMovesFromWinningMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends OTwoMovesFromWinningMatch {
  ...
  private static final class Immutable extends OTwoMovesFromWinningMatch {
