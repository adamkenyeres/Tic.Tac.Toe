...
/**
 * Pattern-specific match representation of the queries.OWinningDiagonalRight pattern,
 * to be used in conjunction with {@link OWinningDiagonalRightMatcher}.
 * 
...
public abstract class OWinningDiagonalRightMatch extends BasePatternMatch {
  ...
  private OWinningDiagonalRightMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return OWinningDiagonalRightMatch.parameterNames;
  }
  ...
  @Override
  public OWinningDiagonalRightMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OWinningDiagonalRightMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OWinningDiagonalRightMatch other = (OWinningDiagonalRightMatch) obj;
  ...
  @Override
  public OWinningDiagonalRightQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OWinningDiagonalRightMatch newEmptyMatch() {
   ...
   * 
   */
  public static OWinningDiagonalRightMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static OWinningDiagonalRightMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends OWinningDiagonalRightMatch {
  ...
  private static final class Immutable extends OWinningDiagonalRightMatch {
