...
/**
 * Pattern-specific match representation of the queries.OWinningHorizontal pattern,
 * to be used in conjunction with {@link OWinningHorizontalMatcher}.
 * 
...
public abstract class OWinningHorizontalMatch extends BasePatternMatch {
  ...
  private OWinningHorizontalMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return OWinningHorizontalMatch.parameterNames;
  }
  ...
  @Override
  public OWinningHorizontalMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OWinningHorizontalMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OWinningHorizontalMatch other = (OWinningHorizontalMatch) obj;
  ...
  @Override
  public OWinningHorizontalQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OWinningHorizontalMatch newEmptyMatch() {
   ...
   * 
   */
  public static OWinningHorizontalMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static OWinningHorizontalMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends OWinningHorizontalMatch {
  ...
  private static final class Immutable extends OWinningHorizontalMatch {
