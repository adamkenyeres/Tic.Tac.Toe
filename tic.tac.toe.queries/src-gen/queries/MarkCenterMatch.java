...
/**
 * Pattern-specific match representation of the queries.markCenter pattern,
 * to be used in conjunction with {@link MarkCenterMatcher}.
 * 
 ...
 * @see MarkCenterProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class MarkCenterMatch extends BasePatternMatch {
  ...
  private MarkCenterMatch(final Square pSquare, final Engine pEngine) {
  ...
  public List<String> parameterNames() {
    return MarkCenterMatch.parameterNames;
  }
  ...
  @Override
  public MarkCenterMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MarkCenterMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MarkCenterMatch other = (MarkCenterMatch) obj;
  ...
  @Override
  public MarkCenterQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MarkCenterMatch newEmptyMatch() {
   ...
   * 
   */
  public static MarkCenterMatch newMutableMatch(final Square pSquare, final Engine pEngine) {
   ...
   * 
   */
  public static MarkCenterMatch newMatch(final Square pSquare, final Engine pEngine) {
    return new Immutable(pSquare, pEngine);
  }
  
  private static final class Mutable extends MarkCenterMatch {
  ...
  private static final class Immutable extends MarkCenterMatch {
