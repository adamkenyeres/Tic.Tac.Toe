...
/**
 * Pattern-specific match representation of the queries.SouthEast pattern,
 * to be used in conjunction with {@link SouthEastMatcher}.
 * 
...
public abstract class SouthEastMatch extends BasePatternMatch {
  ...
  private SouthEastMatch(final Square pSquareN, final Square pSquareS, final Engine pEngine) {
  ...
  public List<String> parameterNames() {
    return SouthEastMatch.parameterNames;
  }
  ...
  @Override
  public SouthEastMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SouthEastMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SouthEastMatch other = (SouthEastMatch) obj;
  ...
  @Override
  public SouthEastQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SouthEastMatch newEmptyMatch() {
   ...
   * 
   */
  public static SouthEastMatch newMutableMatch(final Square pSquareN, final Square pSquareS, final Engine pEngine) {
   ...
   * 
   */
  public static SouthEastMatch newMatch(final Square pSquareN, final Square pSquareS, final Engine pEngine) {
    return new Immutable(pSquareN, pSquareS, pEngine);
  }
  
  private static final class Mutable extends SouthEastMatch {
  ...
  private static final class Immutable extends SouthEastMatch {
