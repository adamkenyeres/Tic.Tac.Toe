...
/**
 * Pattern-specific match representation of the queries.TCNorthWithEmptyMarks pattern,
 * to be used in conjunction with {@link TCNorthWithEmptyMarksMatcher}.
 * 
...
public abstract class TCNorthWithEmptyMarksMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCNorthWithEmptyMarksMatch(final Square pS1, final Square pS2, final Engine pEngine) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  ...
  public List<String> parameterNames() {
    return TCNorthWithEmptyMarksMatch.parameterNames;
  }
  ...
  @Override
  public TCNorthWithEmptyMarksMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCNorthWithEmptyMarksMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCNorthWithEmptyMarksMatch other = (TCNorthWithEmptyMarksMatch) obj;
  ...
  @Override
  public TCNorthWithEmptyMarksQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCNorthWithEmptyMarksMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCNorthWithEmptyMarksMatch newMutableMatch(final Square pS1, final Square pS2, final Engine pEngine) {
   ...
   * 
   */
  public static TCNorthWithEmptyMarksMatch newMatch(final Square pS1, final Square pS2, final Engine pEngine) {
    return new Immutable(pS1, pS2, pEngine);
  }
  
  private static final class Mutable extends TCNorthWithEmptyMarksMatch {
  ...
  private static final class Immutable extends TCNorthWithEmptyMarksMatch {
