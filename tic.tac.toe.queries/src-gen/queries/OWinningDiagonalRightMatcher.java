...
/**
 * Generated pattern matcher API of the queries.OWinningDiagonalRight pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link OWinningDiagonalRightMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see OWinningDiagonalRightMatch
 * @see OWinningDiagonalRightProcessor
 * @see OWinningDiagonalRightQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class OWinningDiagonalRightMatcher extends BaseMatcher<OWinningDiagonalRightMatch> {
  /**
   ...
   * 
   */
  public static OWinningDiagonalRightMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    OWinningDiagonalRightMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (OWinningDiagonalRightMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static OWinningDiagonalRightMatcher create() throws ViatraQueryException {
    return new OWinningDiagonalRightMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OWinningDiagonalRightMatcher.class);
   ...
   * 
   */
  private OWinningDiagonalRightMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a OWinningDiagonalRightMatch object.
   * 
   */
  public Collection<OWinningDiagonalRightMatch> getAllMatches(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * @param pEngine the fixed value of pattern parameter engine, or null if not bound.
   * @param pColor the fixed value of pattern parameter color, or null if not bound.
   * @return a match represented as a OWinningDiagonalRightMatch object, or null if no match is found.
   * 
   */
  public OWinningDiagonalRightMatch getOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OWinningDiagonalRightMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OWinningDiagonalRightMatch> processor) {
   ...
   * 
   */
  public OWinningDiagonalRightMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return OWinningDiagonalRightMatch.newMatch(pSquare, pEngine, pColor);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final OWinningDiagonalRightMatch partialMatch) {
   ...
   * 
   */
  public Set<Engine> getAllValuesOfengine(final OWinningDiagonalRightMatch partialMatch) {
   ...
   * 
   */
  public Set<Color> getAllValuesOfcolor(final OWinningDiagonalRightMatch partialMatch) {
  ...
  @Override
  protected OWinningDiagonalRightMatch tupleToMatch(final Tuple t) {
    try {
    	return OWinningDiagonalRightMatch.newMatch((Square) t.get(POSITION_SQUARE), (Engine) t.get(POSITION_ENGINE), (Color) t.get(POSITION_COLOR));
  ...
  @Override
  protected OWinningDiagonalRightMatch arrayToMatch(final Object[] match) {
    try {
    	return OWinningDiagonalRightMatch.newMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected OWinningDiagonalRightMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return OWinningDiagonalRightMatch.newMutableMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<OWinningDiagonalRightMatcher> querySpecification() throws ViatraQueryException {
