...
/**
 * Pattern-specific match representation of the queries.NE pattern,
 * to be used in conjunction with {@link NEMatcher}.
 * 
...
public abstract class NEMatch extends BasePatternMatch {
  ...
  private NEMatch(final Square pSource, final Square pTarget) {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NEMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
  ...
  @Override
  public NEQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static NEMatch newEmptyMatch() {
   ...
   * 
   */
  public static NEMatch newMutableMatch(final Square pSource, final Square pTarget) {
   ...
   * 
   */
  public static NEMatch newMatch(final Square pSource, final Square pTarget) {
    return new Immutable(pSource, pTarget);
  }
  
  private static final class Mutable extends NEMatch {
  ...
  private static final class Immutable extends NEMatch {
