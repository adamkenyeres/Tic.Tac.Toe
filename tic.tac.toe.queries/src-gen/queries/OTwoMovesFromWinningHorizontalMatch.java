...
/**
 * Pattern-specific match representation of the queries.OTwoMovesFromWinningHorizontal pattern,
 * to be used in conjunction with {@link OTwoMovesFromWinningHorizontalMatcher}.
 * 
...
public abstract class OTwoMovesFromWinningHorizontalMatch extends BasePatternMatch {
  ...
  private OTwoMovesFromWinningHorizontalMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return OTwoMovesFromWinningHorizontalMatch.parameterNames;
  }
  ...
  @Override
  public OTwoMovesFromWinningHorizontalMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OTwoMovesFromWinningHorizontalMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OTwoMovesFromWinningHorizontalMatch other = (OTwoMovesFromWinningHorizontalMatch) obj;
  ...
  @Override
  public OTwoMovesFromWinningHorizontalQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OTwoMovesFromWinningHorizontalMatch newEmptyMatch() {
   ...
   * 
   */
  public static OTwoMovesFromWinningHorizontalMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static OTwoMovesFromWinningHorizontalMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends OTwoMovesFromWinningHorizontalMatch {
  ...
  private static final class Immutable extends OTwoMovesFromWinningHorizontalMatch {
