...
/**
 * Generated pattern matcher API of the queries.OWinningVertical pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link OWinningVerticalMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see OWinningVerticalProcessor
 * @see OWinningVerticalQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class OWinningVerticalMatcher extends BaseMatcher<OWinningVerticalMatch> {
  /**
   ...
   * 
   */
  public static OWinningVerticalMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    OWinningVerticalMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (OWinningVerticalMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static OWinningVerticalMatcher create() throws ViatraQueryException {
    return new OWinningVerticalMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OWinningVerticalMatcher.class);
   ...
   * 
   */
  private OWinningVerticalMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a OWinningVerticalMatch object.
   * 
   */
  public Collection<OWinningVerticalMatch> getAllMatches(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * @param pEngine the fixed value of pattern parameter engine, or null if not bound.
   * @param pColor the fixed value of pattern parameter color, or null if not bound.
   * @return a match represented as a OWinningVerticalMatch object, or null if no match is found.
   * 
   */
  public OWinningVerticalMatch getOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OWinningVerticalMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OWinningVerticalMatch> processor) {
   ...
   * 
   */
  public OWinningVerticalMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return OWinningVerticalMatch.newMatch(pSquare, pEngine, pColor);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final OWinningVerticalMatch partialMatch) {
   ...
   * 
   */
  public Set<Engine> getAllValuesOfengine(final OWinningVerticalMatch partialMatch) {
   ...
   * 
   */
  public Set<Color> getAllValuesOfcolor(final OWinningVerticalMatch partialMatch) {
  ...
  @Override
  protected OWinningVerticalMatch tupleToMatch(final Tuple t) {
    try {
    	return OWinningVerticalMatch.newMatch((Square) t.get(POSITION_SQUARE), (Engine) t.get(POSITION_ENGINE), (Color) t.get(POSITION_COLOR));
  ...
  @Override
  protected OWinningVerticalMatch arrayToMatch(final Object[] match) {
    try {
    	return OWinningVerticalMatch.newMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected OWinningVerticalMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return OWinningVerticalMatch.newMutableMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<OWinningVerticalMatcher> querySpecification() throws ViatraQueryException {
