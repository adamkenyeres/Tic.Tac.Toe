...
/**
 * Pattern-specific match representation of the queries.OTwoMovesFromWinningDiagonalRight pattern,
 * to be used in conjunction with {@link OTwoMovesFromWinningDiagonalRightMatcher}.
 * 
...
public abstract class OTwoMovesFromWinningDiagonalRightMatch extends BasePatternMatch {
  ...
  private OTwoMovesFromWinningDiagonalRightMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return OTwoMovesFromWinningDiagonalRightMatch.parameterNames;
  }
  ...
  @Override
  public OTwoMovesFromWinningDiagonalRightMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OTwoMovesFromWinningDiagonalRightMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OTwoMovesFromWinningDiagonalRightMatch other = (OTwoMovesFromWinningDiagonalRightMatch) obj;
  ...
  @Override
  public OTwoMovesFromWinningDiagonalRightQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OTwoMovesFromWinningDiagonalRightMatch newEmptyMatch() {
   ...
   * 
   */
  public static OTwoMovesFromWinningDiagonalRightMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static OTwoMovesFromWinningDiagonalRightMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends OTwoMovesFromWinningDiagonalRightMatch {
  ...
  private static final class Immutable extends OTwoMovesFromWinningDiagonalRightMatch {
