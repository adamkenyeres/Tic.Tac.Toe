...
/**
 * Pattern-specific match representation of the queries.TCSouthWestWithSameMarks pattern,
 * to be used in conjunction with {@link TCSouthWestWithSameMarksMatcher}.
 * 
...
public abstract class TCSouthWestWithSameMarksMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCSouthWestWithSameMarksMatch(final Square pS1, final Square pS2, final Color pColor) {
    this.fS1 = pS1;
    this.fS2 = pS2;
    this.fColor = pColor;
  }
  ...
  public List<String> parameterNames() {
    return TCSouthWestWithSameMarksMatch.parameterNames;
  }
  ...
  @Override
  public TCSouthWestWithSameMarksMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCSouthWestWithSameMarksMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCSouthWestWithSameMarksMatch other = (TCSouthWestWithSameMarksMatch) obj;
  ...
  @Override
  public TCSouthWestWithSameMarksQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCSouthWestWithSameMarksMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCSouthWestWithSameMarksMatch newMutableMatch(final Square pS1, final Square pS2, final Color pColor) {
   ...
   * 
   */
  public static TCSouthWestWithSameMarksMatch newMatch(final Square pS1, final Square pS2, final Color pColor) {
    return new Immutable(pS1, pS2, pColor);
  }
  
  private static final class Mutable extends TCSouthWestWithSameMarksMatch {
  ...
  private static final class Immutable extends TCSouthWestWithSameMarksMatch {
