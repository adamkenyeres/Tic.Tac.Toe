...
/**
 * Pattern-specific match representation of the queries.E pattern,
...
public abstract class EMatch extends BasePatternMatch {
  ...
  private EMatch(final Square pSource, final Square pTarget) {
  ...
  @Override
  public EQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EMatch newEmptyMatch() {
   ...
   * 
   */
  public static EMatch newMutableMatch(final Square pSource, final Square pTarget) {
   ...
   * 
   */
  public static EMatch newMatch(final Square pSource, final Square pTarget) {
    return new Immutable(pSource, pTarget);
  }
  
  private static final class Mutable extends EMatch {
  ...
  private static final class Immutable extends EMatch {
