...
/**
 * Generated pattern matcher API of the queries.OTwoMovesFromWinningVertical pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link OTwoMovesFromWinningVerticalMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * pattern
 ...
 * @see OTwoMovesFromWinningVerticalQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class OTwoMovesFromWinningVerticalMatcher extends BaseMatcher<OTwoMovesFromWinningVerticalMatch> {
  /**
   ...
   * 
   */
  public static OTwoMovesFromWinningVerticalMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    OTwoMovesFromWinningVerticalMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (OTwoMovesFromWinningVerticalMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static OTwoMovesFromWinningVerticalMatcher create() throws ViatraQueryException {
    return new OTwoMovesFromWinningVerticalMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OTwoMovesFromWinningVerticalMatcher.class);
   ...
   * 
   */
  private OTwoMovesFromWinningVerticalMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a OTwoMovesFromWinningVerticalMatch object.
   * 
   */
  public Collection<OTwoMovesFromWinningVerticalMatch> getAllMatches(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * @param pEngine the fixed value of pattern parameter engine, or null if not bound.
   * @param pColor the fixed value of pattern parameter color, or null if not bound.
   * @return a match represented as a OTwoMovesFromWinningVerticalMatch object, or null if no match is found.
   * 
   */
  public OTwoMovesFromWinningVerticalMatch getOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OTwoMovesFromWinningVerticalMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super OTwoMovesFromWinningVerticalMatch> processor) {
   ...
   * 
   */
  public OTwoMovesFromWinningVerticalMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return OTwoMovesFromWinningVerticalMatch.newMatch(pSquare, pEngine, pColor);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final OTwoMovesFromWinningVerticalMatch partialMatch) {
   ...
   * 
   */
  public Set<Engine> getAllValuesOfengine(final OTwoMovesFromWinningVerticalMatch partialMatch) {
   ...
   * 
   */
  public Set<Color> getAllValuesOfcolor(final OTwoMovesFromWinningVerticalMatch partialMatch) {
  ...
  @Override
  protected OTwoMovesFromWinningVerticalMatch tupleToMatch(final Tuple t) {
    try {
    	return OTwoMovesFromWinningVerticalMatch.newMatch((Square) t.get(POSITION_SQUARE), (Engine) t.get(POSITION_ENGINE), (Color) t.get(POSITION_COLOR));
  ...
  @Override
  protected OTwoMovesFromWinningVerticalMatch arrayToMatch(final Object[] match) {
    try {
    	return OTwoMovesFromWinningVerticalMatch.newMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected OTwoMovesFromWinningVerticalMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return OTwoMovesFromWinningVerticalMatch.newMutableMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<OTwoMovesFromWinningVerticalMatcher> querySpecification() throws ViatraQueryException {
