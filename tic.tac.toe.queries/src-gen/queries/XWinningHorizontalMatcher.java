...
import queries.XWinningHorizontalMatch;
...
/**
 * Generated pattern matcher API of the queries.XWinningHorizontal pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link XWinningHorizontalMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see XWinningHorizontalMatch
 * @see XWinningHorizontalProcessor
 * @see XWinningHorizontalQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class XWinningHorizontalMatcher extends BaseMatcher<XWinningHorizontalMatch> {
  /**
   ...
   * 
   */
  public static XWinningHorizontalMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    XWinningHorizontalMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (XWinningHorizontalMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static XWinningHorizontalMatcher create() throws ViatraQueryException {
    return new XWinningHorizontalMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(XWinningHorizontalMatcher.class);
   ...
   * 
   */
  private XWinningHorizontalMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a XWinningHorizontalMatch object.
   * 
   */
  public Collection<XWinningHorizontalMatch> getAllMatches(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * @param pEngine the fixed value of pattern parameter engine, or null if not bound.
   * @param pColor the fixed value of pattern parameter color, or null if not bound.
   * @return a match represented as a XWinningHorizontalMatch object, or null if no match is found.
   * 
   */
  public XWinningHorizontalMatch getOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super XWinningHorizontalMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquare, final Engine pEngine, final Color pColor, final IMatchProcessor<? super XWinningHorizontalMatch> processor) {
   ...
   * 
   */
  public XWinningHorizontalMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return XWinningHorizontalMatch.newMatch(pSquare, pEngine, pColor);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final XWinningHorizontalMatch partialMatch) {
   ...
   * 
   */
  public Set<Engine> getAllValuesOfengine(final XWinningHorizontalMatch partialMatch) {
   ...
   * 
   */
  public Set<Color> getAllValuesOfcolor(final XWinningHorizontalMatch partialMatch) {
  ...
  @Override
  protected XWinningHorizontalMatch tupleToMatch(final Tuple t) {
    try {
    	return XWinningHorizontalMatch.newMatch((Square) t.get(POSITION_SQUARE), (Engine) t.get(POSITION_ENGINE), (Color) t.get(POSITION_COLOR));
  ...
  @Override
  protected XWinningHorizontalMatch arrayToMatch(final Object[] match) {
    try {
    	return XWinningHorizontalMatch.newMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected XWinningHorizontalMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return XWinningHorizontalMatch.newMutableMatch((Square) match[POSITION_SQUARE], (Engine) match[POSITION_ENGINE], (Color) match[POSITION_COLOR]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<XWinningHorizontalMatcher> querySpecification() throws ViatraQueryException {
