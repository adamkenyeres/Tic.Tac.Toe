...
/**
 * Pattern-specific match representation of the queries.forceOWin pattern,
 * to be used in conjunction with {@link ForceOWinMatcher}.
 * 
...
public abstract class ForceOWinMatch extends BasePatternMatch {
  ...
  private ForceOWinMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return ForceOWinMatch.parameterNames;
  }
  ...
  @Override
  public ForceOWinMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ForceOWinMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ForceOWinMatch other = (ForceOWinMatch) obj;
  ...
  @Override
  public ForceOWinQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ForceOWinMatch newEmptyMatch() {
   ...
   * 
   */
  public static ForceOWinMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static ForceOWinMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends ForceOWinMatch {
  ...
  private static final class Immutable extends ForceOWinMatch {
