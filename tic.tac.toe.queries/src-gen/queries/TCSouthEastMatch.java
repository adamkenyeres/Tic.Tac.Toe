...
/**
 * Pattern-specific match representation of the queries.TCSouthEast pattern,
 * to be used in conjunction with {@link TCSouthEastMatcher}.
 * 
...
public abstract class TCSouthEastMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCSouthEastMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return TCSouthEastMatch.parameterNames;
  }
  ...
  @Override
  public TCSouthEastMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCSouthEastMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCSouthEastMatch other = (TCSouthEastMatch) obj;
  ...
  @Override
  public TCSouthEastQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCSouthEastMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCSouthEastMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static TCSouthEastMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends TCSouthEastMatch {
  ...
  private static final class Immutable extends TCSouthEastMatch {
