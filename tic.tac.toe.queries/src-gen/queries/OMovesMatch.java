...
/**
 * Pattern-specific match representation of the queries.OMoves pattern,
 * to be used in conjunction with {@link OMovesMatcher}.
 * 
...
public abstract class OMovesMatch extends BasePatternMatch {
  ...
  private OMovesMatch(final Square pSquare, final Engine pEngine) {
  ...
  public List<String> parameterNames() {
    return OMovesMatch.parameterNames;
  }
  ...
  @Override
  public OMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OMovesMatch other = (OMovesMatch) obj;
  ...
  @Override
  public OMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static OMovesMatch newMutableMatch(final Square pSquare, final Engine pEngine) {
   ...
   * 
   */
  public static OMovesMatch newMatch(final Square pSquare, final Engine pEngine) {
    return new Immutable(pSquare, pEngine);
  }
  
  private static final class Mutable extends OMovesMatch {
  ...
  private static final class Immutable extends OMovesMatch {
