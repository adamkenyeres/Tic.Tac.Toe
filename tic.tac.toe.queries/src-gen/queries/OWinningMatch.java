...
/**
 * Pattern-specific match representation of the queries.OWinning pattern,
 * to be used in conjunction with {@link OWinningMatcher}.
 * 
...
public abstract class OWinningMatch extends BasePatternMatch {
  ...
  private OWinningMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
  ...
  public List<String> parameterNames() {
    return OWinningMatch.parameterNames;
  }
  ...
  @Override
  public OWinningMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OWinningMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OWinningMatch other = (OWinningMatch) obj;
  ...
  @Override
  public OWinningQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OWinningMatch newEmptyMatch() {
   ...
   * 
   */
  public static OWinningMatch newMutableMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
   ...
   * 
   */
  public static OWinningMatch newMatch(final Square pSquare, final Engine pEngine, final Color pColor) {
    return new Immutable(pSquare, pEngine, pColor);
  }
  
  private static final class Mutable extends OWinningMatch {
  ...
  private static final class Immutable extends OWinningMatch {
