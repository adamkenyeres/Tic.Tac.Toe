...
/**
 * Pattern-specific match representation of the queries.TCEastWithSameMarks pattern,
 * to be used in conjunction with {@link TCEastWithSameMarksMatcher}.
 * 
...
public abstract class TCEastWithSameMarksMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private TCEastWithSameMarksMatch(final Square pS1, final Square pS2, final Color pColor) {
    this.fS1 = pS1;
    this.fS2 = pS2;
    this.fColor = pColor;
  }
  ...
  public List<String> parameterNames() {
    return TCEastWithSameMarksMatch.parameterNames;
  }
  ...
  @Override
  public TCEastWithSameMarksMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TCEastWithSameMarksMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TCEastWithSameMarksMatch other = (TCEastWithSameMarksMatch) obj;
  ...
  @Override
  public TCEastWithSameMarksQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TCEastWithSameMarksMatch newEmptyMatch() {
   ...
   * 
   */
  public static TCEastWithSameMarksMatch newMutableMatch(final Square pS1, final Square pS2, final Color pColor) {
   ...
   * 
   */
  public static TCEastWithSameMarksMatch newMatch(final Square pS1, final Square pS2, final Color pColor) {
    return new Immutable(pS1, pS2, pColor);
  }
  
  private static final class Mutable extends TCEastWithSameMarksMatch {
  ...
  private static final class Immutable extends TCEastWithSameMarksMatch {
