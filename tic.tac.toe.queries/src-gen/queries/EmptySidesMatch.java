...
/**
 * Pattern-specific match representation of the queries.emptySides pattern,
 * to be used in conjunction with {@link EmptySidesMatcher}.
 * 
...
public abstract class EmptySidesMatch extends BasePatternMatch {
  ...
  private EmptySidesMatch(final Square pSquare, final Engine pEngine) {
  ...
  public List<String> parameterNames() {
    return EmptySidesMatch.parameterNames;
  }
  ...
  @Override
  public EmptySidesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof EmptySidesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    EmptySidesMatch other = (EmptySidesMatch) obj;
  ...
  @Override
  public EmptySidesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EmptySidesMatch newEmptyMatch() {
   ...
   * 
   */
  public static EmptySidesMatch newMutableMatch(final Square pSquare, final Engine pEngine) {
   ...
   * 
   */
  public static EmptySidesMatch newMatch(final Square pSquare, final Engine pEngine) {
    return new Immutable(pSquare, pEngine);
  }
  
  private static final class Mutable extends EmptySidesMatch {
  ...
  private static final class Immutable extends EmptySidesMatch {
