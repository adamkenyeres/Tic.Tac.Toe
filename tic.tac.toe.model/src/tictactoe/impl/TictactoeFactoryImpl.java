...
public class TictactoeFactoryImpl extends EFactoryImpl implements TictactoeFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TictactoePackage.ENGINE: return createEngine();
			case TictactoePackage.SQUARE: return createSquare();
			case TictactoePackage.PLAYER: return createPlayer();
			case TictactoePackage.MARK: return createMark();
			default:
